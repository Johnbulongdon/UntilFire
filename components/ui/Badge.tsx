...
const TONES: Record<BadgeTone, React.CSSProperties> = {
  positive: { background: "var(--uf-green-50)",  color: "var(--uf-green)" },
  negative: { background: "var(--uf-neg-bg)",    color: "var(--uf-neg)" },
  warning:  { background: "var(--uf-warn-bg)",   color: "var(--uf-warn)" },
  freedom:  { background: "var(--uf-teal-soft)", color: "var(--uf-teal)" },
