...
export const learnArticles: LearnArticle[] = [
  ...
  {
    slug: 'credit-card-rewards-and-fire',
    title: 'Credit Card Rewards and FIRE: How to Turn Spending Into Free Travel',
    description: 'How to use credit card rewards strategically to effectively boost your savings rate — without carrying a balance or chasing complexity you do not need.',
    category: 'Planning',
    publishedAt: '2026-06-18',
    readTime: '5 min read',
    body: [
      h2('Rewards as a savings rate boost'),
      p('Credit card rewards are not a path to wealth, but they are a consistent, low-effort way to extract additional value from spending you were going to do anyway. For a household spending $4,000 per month on a 2% cashback card, that is $960 per year in free money — effectively a 1–2% savings rate boost at no extra cost.'),
      p('For FIRE planners tracking every dollar, this is not trivial. $960/year invested at 7% for 20 years is over $40,000. The rewards stack compounds over a long timeline.'),
      h2('The two main strategies: cashback vs travel points'),
      p('Cashback cards are simpler: you earn a percentage of spending back as cash, which you invest or apply to the balance. The math is transparent. 2% on all spending, 5% on rotating categories — straightforward.'),
      p('Travel points cards offer higher potential redemption value but require more management. A $450 annual fee card might provide $900–$1,500 in annual travel value through lounge access, statement credits, and point redemptions — if you fly frequently and use the benefits. If you do not travel much, the fee erodes the return.'),
      p('For most FIRE planners who want simplicity: a no-annual-fee 2% cashback card covers everything. For frequent travelers: one or two premium cards with credits that exceed the annual fee, used strategically.'),
      h2('The cardinal rule: never carry a balance'),
      p('Credit card rewards are only net-positive if you pay the full balance every month. At a typical 20–25% APR, carrying even a small balance erases months of rewards within days. The entire premise of rewards optimization requires treating the credit card as a spending tool, not a credit product.'),
      p('If you have a history of carrying balances, the psychological risk outweighs the reward upside. Stick to a debit card until spending is fully under control.'),
      h2('Signup bonuses: the high-value event'),
      p('Signup bonuses are where credit card rewards offer their highest return. A card offering 60,000 points after spending $4,000 in 3 months — worth $600–$1,200 depending on redemption — is a 15–30% return on that $4,000 of spend. Churning cards (opening new cards for the signup bonus, then closing them after the annual fee hits) is a full strategy some FIRE practitioners use to fund substantial travel.'),
      p('The risks: hard credit inquiries temporarily lower your credit score, and lenders track signup bonus frequency. If you are planning a mortgage or major loan within 12 months, pause churning during that period.'),
      h2('What to do with cashback'),
      p('The simplest approach: auto-redeem cashback to your brokerage account each month. Most major cashback cards allow automatic redemption to a linked checking account. Set it up once and forget it — the rewards invest themselves.'),
      p('Many FIRE practitioners find that their annual credit card rewards cover one month of living expenses, or fund a vacation that would otherwise come from savings. Either outcome — more investing or less discretionary spending — advances the FIRE timeline.'),
      h2('Avoiding the traps'),
      ul([
        'Annual fee cards only make sense if you use the credits. Do the math annually: does the value received exceed the fee?',
        'Category bonuses (5% on groceries, 3% on gas) require attention to which card to use where. More than 2–3 cards becomes cognitive overhead that erodes the advantage.',
        'Spending more to earn more is always a net loss. Rewards optimization means extracting value from planned spending, not creating new spending.',
        'Points devaluation is real — loyalty programs reduce redemption value over time. Cashback holds its value; points need to be used within 1–2 years.',
      ]),
    ],
  },
  {
    slug: 'building-multiple-income-streams-on-the-fire-path',
    title: 'Building Multiple Income Streams on the FIRE Path',
    description: 'Why diversifying income sources reduces both FIRE timeline risk and post-FIRE fragility — and the practical income streams that work alongside a primary job.',
    category: 'Planning',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('Why a single income source is fragile'),
      p('A single-income FIRE plan is vulnerable to one risk: your job. Job loss, illness, industry disruption, or employer decisions can pause or reverse years of progress. A household with three income streams — salary, rental income, and freelance work — can absorb any one disruption without catastrophic impact on the FIRE timeline.'),
      p('Income diversification is not primarily about earning more (though that helps). It is about reducing the single-point-of-failure risk in a 15–25 year savings journey.'),
      h2('The income stream hierarchy'),
      p('Not all income streams are equally valuable for FIRE. Ranked by FIRE impact:'),
      ol([
        'Primary job income: the highest total dollar amount for most people. Optimise this first — career advancement, negotiation, switching to higher-paying fields.',
        'Investment income (dividends, bond interest): grows automatically with the portfolio. No effort required once invested.',
        'Real estate income: rental cash flow that partially covers living expenses in both accumulation and retirement.',
        'Side income with FIRE-compatible properties: flexible hours, skill-based, location-independent (consulting, freelance, teaching, creative work).',
        'Passive or semi-passive income: products, courses, licensing, digital assets that generate ongoing revenue with declining marginal effort.',
      ]),
      h2('Starting a side income stream'),
      p('Most successful side income starts by monetizing existing skills. The clearest path: identify what you are paid well for at your job, then offer a version of it outside your employment context.'),
      p('Examples by profession:'),
      ul([
        'Software engineers: freelance development, code review contracts, technical writing',
        'Finance/accounting professionals: tax preparation, bookkeeping, financial planning',
        'Teachers/educators: tutoring, online courses, curriculum development',
        'Healthcare workers: locum tenens shifts, medical writing, telehealth',
        'Marketers/designers: freelance client work, consulting retainers',
      ]),
      p('The goal for an early-stage side income is not to replace the primary job — it is to generate $10,000–$30,000/year with 5–10 hours/week, add to the investment contribution rate, and build the skill and reputation for eventual scale.'),
      h2('Investment income as the foundation'),
      p('For FIRE planners, investment income is the most important long-run income stream. Dividends from stock index funds, bond interest, and REIT distributions grow with the portfolio and eventually cover living expenses without any active effort.'),
      p('A $500,000 portfolio in a broad market index fund with a 1.5–2% dividend yield generates $7,500–$10,000/year in dividends. A $1,500,000 portfolio generates $22,500–$30,000 — enough to cover half or more of a lean to moderate spending lifestyle. By FIRE, investment income significantly reduces or eliminates the reliance on portfolio drawdown.'),
      h2('The practical sequencing'),
      p('Building multiple income streams does not require doing everything simultaneously. A practical sequence for most FIRE planners:'),
      ul([
        'Years 1–5: maximise primary job income through advancement and negotiation. Automate investments.',
        'Years 3–8: start one side income stream. Keep it small — the goal is proving the model and generating $10k–$20k/year, not building a second career.',
        'Years 5–15: let investment income grow in the background. It is the income stream that requires no attention once the portfolio compounds.',
        'Years 10+: assess whether side income has grown enough to contribute materially to FIRE date. If the side income covers expenses in early retirement, the portfolio FIRE number drops significantly.',
      ]),
      h2('The post-FIRE income landscape'),
      p('Multiple income streams are even more valuable in early retirement than during accumulation. The classic risk of FIRE — withdrawing from a portfolio during an early bad market — is substantially mitigated if you have $20,000–$30,000/year in non-portfolio income.'),
      p('The portfolio only needs to cover the gap. A household with $60,000 in annual expenses and $25,000 in rental/side income only needs to withdraw $35,000 from the portfolio — an effective withdrawal rate of 2.3% on a $1,500,000 portfolio, which is robust to nearly any market scenario.'),
    ],
  },
  {
    slug: 'fire-community-books-podcasts-resources',
    title: 'FIRE Resources: The Best Books, Podcasts, and Communities',
    description: 'The most useful books, podcasts, and online communities for learning financial independence and connecting with others on the same path.',
    category: 'FIRE Basics',
    publishedAt: '2026-06-18',
    readTime: '5 min read',
    body: [
      h2('Why community accelerates the FIRE path'),
      p('FIRE is a contrarian path in a culture that normalises lifestyle inflation and defers financial thinking to employers and advisors. Community matters because it provides shared language, practical knowledge exchange, and the normalisation of choices that seem unusual to most peers — living below your means, maximising savings rate, treating retirement as a near-term goal rather than a distant abstraction.'),
      p('The resources below are the most referenced and highest-quality across the FIRE community. They are a starting library, not a required reading list.'),
      h2('Essential books'),
      ul([
        'Your Money or Your Life — Vicki Robin and Joe Dominguez: the philosophical and practical foundation of the movement. Connects money to life energy and time. Still essential 30 years after publication.',
        'The Simple Path to Wealth — JL Collins: the clearest single explanation of the index fund approach to wealth building. Written as a letter to the author\'s daughter. Practical, direct, and persuasive.',
        'Early Retirement Extreme — Jacob Lund Fisker: the intellectual foundation of Lean FIRE and systematic frugality. More philosophical and demanding than most FIRE reading but highly original.',
        'Die With Zero — Bill Perkins: a counterpoint worth reading. Argues for spending more intentionally throughout life rather than over-accumulating. Useful for calibrating how much is enough.',
        'The Psychology of Money — Morgan Housel: the best book on how human behavior affects financial outcomes. Not FIRE-specific but essential context for long-term investing discipline.',
      ]),
      h2('Podcasts'),
      ul([
        'ChooseFI: the most popular FIRE podcast. Interviews, strategies, and community stories. Long-running and accessible.',
        'Afford Anything — Paula Pant: broader personal finance framing with strong FIRE content. "You can afford anything, but not everything" — the thesis.',
        'The Mad Fientist Podcast: technical deep-dives on FIRE strategy — Roth ladders, tax optimization, account sequencing. Less frequent but high quality.',
        'BiggerPockets Money: covers FIRE alongside real estate investing. Good for those interested in rental property as part of the path.',
        'Catching Up to FI: focused on people starting the FIRE journey in their 40s and 50s — practical for those who did not start early.',
      ]),
      h2('Online communities'),
      ul([
        'r/financialindependence (Reddit): the largest FIRE community online. Millions of members, daily discussion of strategies, case studies, and milestone posts. High signal-to-noise ratio for a large subreddit.',
        'r/leanfire: focused on Lean FIRE practitioners. More frugality-oriented discussion.',
        'r/fatFIRE: high-income FIRE planners. Different constraints and strategies.',
        'Bogleheads.org: the definitive forum for index fund investing philosophy. Not FIRE-specific but the best place for detailed investment mechanics questions.',
        'ChooseFI local chapters: in-person meetups in many cities. Face-to-face community for FIRE practitioners.',
      ]),
      h2('Calculators and tools'),
      ul([
        'UntilFire: full FIRE calculator, freedom date, and guided next steps — all without login.',
        'FIRECalc: tests your plan against all historical market periods.',
        'cFIREsim: FIRE-specific Monte Carlo with Social Security and part-time income inputs.',
        'Portfolio Visualizer: advanced Monte Carlo and portfolio analysis.',
        'Personal Capital / Empower: net worth tracking and investment overview.',
      ]),
      h2('Where to start if you are new'),
      p('If you are new to FIRE, the clearest starting sequence: read The Simple Path to Wealth for the investment framework, subscribe to ChooseFI for ongoing community and strategy, and run your FIRE calculation to see your personal timeline. The combination of philosophical foundation, community, and personal numbers creates the clarity most people need to act.'),
      p('The best resource is the one you actually use. Avoid the trap of perpetual research — at some point the only move that matters is running the numbers and starting to save.'),
    ],
  },
]
...
const articleMetaBySlug: Record<string, LearnArticleMeta> = {
  ...
  'credit-card-rewards-and-fire': {
    primaryStage: 'building-momentum',
    secondaryStages: ['starting-out'],
    relatedCalculators: [
      { href: '/calculators/savings-rate', label: 'Savings Rate Calculator' },
      { href: '/?source=learn-credit-rewards', label: 'FIRE Calculator' },
    ],
  },
  'building-multiple-income-streams-on-the-fire-path': {
    primaryStage: 'building-momentum',
    secondaryStages: ['approaching-fire', 'living-in-fire'],
    relatedCalculators: [
      { href: '/calculators/savings-rate', label: 'Savings Rate Calculator' },
  ...
  'fire-community-books-podcasts-resources': {
    primaryStage: 'starting-out',
    secondaryStages: ['building-momentum'],
    relatedCalculators: [
      { href: '/?source=learn-community', label: 'FIRE Calculator' },
      { href: '/calculators/4-percent-rule', label: 'FIRE Number Calculator' },
    ],
  },
}
