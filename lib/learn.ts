...
export const learnArticles: LearnArticle[] = [
  ...
  {
    slug: 'roth-conversion-ladder-early-retirement-access',
    title: 'The Roth Conversion Ladder: How to Access Retirement Funds Before 59½',
    description: 'How to use the Roth conversion ladder to bridge early retirement income from tax-advantaged accounts without paying the 10% early withdrawal penalty.',
    category: 'Tax Strategy',
    publishedAt: '2026-06-18',
    readTime: '7 min read',
    body: [
      h2('The early retirement access problem'),
      p('Most retirement accounts — 401(k)s and traditional IRAs — are designed for people who retire at 59½ or later. Withdraw before that age and you pay a 10% penalty on top of ordinary income taxes. For early retirees in their 30s, 40s, or 50s, this creates a problem: most of their wealth is locked in tax-advantaged accounts they technically cannot touch.'),
      p('The Roth conversion ladder solves this. It is a method of systematically converting traditional IRA money to Roth IRA money, then waiting five years and withdrawing the converted principal penalty-free. Done correctly, it gives early retirees a steady income stream from tax-advantaged accounts without the 10% penalty.'),
      h2('How the Roth conversion ladder works'),
      p('The key mechanics:'),
      ol([
        'Every year in early retirement, convert a specific amount from your traditional IRA (or rollover from 401k) to your Roth IRA.',
        'You pay ordinary income taxes on the converted amount in the year of conversion.',
        'After exactly five years, you can withdraw that converted principal tax-free and penalty-free.',
        'The strategy creates a rolling 5-year ladder — conversions done today become accessible in year 5, year 6, year 7, and so on.',
      ]),
      p('The five-year waiting period is the critical constraint. Early retirees need to start conversions five years before they need to draw on them — which means either starting before leaving work, or using other funds (taxable brokerage, Roth contributions, or cash) to bridge the first five years.'),
      h2('A concrete example'),
      p('You retire at age 45 with $800,000 in a traditional IRA and $200,000 in a taxable brokerage. Your annual spending is $50,000.'),
      ul([
        'Ages 45–49: live off taxable brokerage while converting $50,000 per year from traditional IRA to Roth IRA.',
        'Age 50: the first $50,000 converted in year 45 becomes accessible penalty-free.',
        'From age 50 onward: each year, withdraw the batch converted five years ago. Simultaneously convert the next year\'s batch.',
      ]),
      p('Because your income in early retirement is low (you are not working), the conversions may fall in a 0% or 10% tax bracket — far less than the tax you would pay in high-earning working years.'),
      h2('The tax efficiency angle'),
      p('The Roth conversion ladder is most powerful when early retirement income is low. In a year with $0 in earned income, you can convert up to approximately $47,150 (2024 thresholds for a single filer) before crossing into the 12% bracket. A couple with two standard deductions can convert even more at 0–10% rates.'),
      p('This is a massive tax arbitrage: you deferred taxes during high-income working years (at 22–32%+ rates), then convert during low-income retirement years at 0–12%. The spread is a permanent tax savings.'),
      h2('What to use for the first five years'),
      p('The common bridges:'),
      ul([
        'Taxable brokerage account: the simplest option — sell investments as needed. Long-term capital gains are taxed at 0% for incomes below roughly $47,025 (single, 2024).',
        'Roth IRA contributions (not earnings): you can always withdraw Roth contributions (not conversions or earnings) at any age without penalty.',
        'Cash or high-yield savings: if you have cash reserves, use them while conversions season.',
        'Part-time income: Barista FIRE income fills the gap and reduces how much you need to convert or draw.',
      ]),
      h2('Important rules to know'),
      ul([
        'Each conversion has its own five-year clock. A conversion in 2026 is accessible in 2031, and a conversion in 2027 is accessible in 2032.',
        'The five-year rule for conversions is separate from the five-year rule for Roth earnings. Earnings in a Roth IRA require you to be 59½ AND have had any Roth IRA open for five years to withdraw tax-free.',
        'You must have taxable income (or at least not violate AGI limits) in the year of conversion — converting from a traditional IRA is a taxable event.',
        '72(t) SEPP (Substantially Equal Periodic Payments) is an alternative for those who need more immediate access, but it is inflexible and hard to modify once started.',
      ]),
      h2('Is the Roth ladder right for you?'),
      p('The Roth conversion ladder is ideal for early retirees who: have substantial traditional IRA or 401(k) balances, have a 5+ year bridge available, and expect to be in lower tax brackets in early retirement. If you have large taxable accounts or significant Roth contributions, you may not need the ladder at all. If your traditional accounts are small, the effort may not be worth the complexity.'),
    ],
  },
  {
    slug: 'healthcare-before-medicare-early-retirement',
    title: 'Healthcare Before Medicare: The Early Retiree\'s Guide',
    description: 'How to find and afford health insurance coverage in the years between leaving work and Medicare eligibility at 65 — the biggest financial wildcard in early retirement.',
    category: 'Planning',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('Why healthcare is the hardest part of early retirement'),
      p('Most FIRE planning focuses on portfolio size, withdrawal rates, and spending. Healthcare is often the afterthought — until you price it. For an early retiree in their 40s or 50s, health insurance without employer coverage can cost $500–$1,500 per month for a single person, and $1,500–$3,000+ per household. Over 10–20 years before Medicare, that is a material budget item.'),
      p('The gap between leaving work and Medicare eligibility at age 65 is the period where healthcare cost risk is highest. Understanding the options is essential before you model a FIRE budget.'),
      h2('The ACA marketplace: the primary option'),
      p('The Affordable Care Act (ACA) marketplace is the main source of health insurance for early retirees. Plans are available during open enrollment (November 1 – January 15) or immediately if you have a qualifying life event (like leaving a job). Key points:'),
      ul([
        'Premiums are income-based. The less income you report, the higher your subsidy. Early retirees with modest portfolio withdrawals and minimal taxable income often qualify for significant premium tax credits.',
        'ACA plans cannot deny coverage for pre-existing conditions.',
        'For 2023 and 2024, the American Rescue Plan enhanced subsidies are in effect, making coverage much cheaper for people with incomes between 100–400% of the federal poverty line.',
        'Silver plans are typically the best choice for subsidy optimization because cost-sharing reductions layer on top of premium credits for lower-income households.',
      ]),
      h2('Managing income to reduce premiums'),
      p('The ACA premium tax credit is calculated based on Modified Adjusted Gross Income (MAGI) — which for most early retirees is: Roth conversions + taxable investment gains + any earned income. This creates a lever.'),
      p('By managing how much you convert from traditional IRAs and how much you sell from taxable accounts, you can keep MAGI low enough to qualify for substantial subsidies. A couple targeting $50,000 in annual spending might keep MAGI under $70,000 by drawing heavily from Roth contributions and cash, which do not count as MAGI.'),
      h2('COBRA: the temporary bridge'),
      p('When you leave a job, COBRA allows you to continue your employer\'s health coverage for up to 18 months. The catch: you pay the full premium — both the employee and employer portions — plus a 2% admin fee. COBRA typically costs $500–$800/month for a single person and $1,200–$2,000+ for families.'),
      p('COBRA is useful as a bridge while you set up ACA coverage (particularly if you have ongoing treatments or want plan continuity). It is rarely the long-term answer — ACA marketplace plans with subsidies are usually cheaper once your income drops.'),
      h2('Health sharing ministries: the cautionary option'),
      p('Health sharing ministries (Sedera, Liberty HealthShare, Zion HealthShare) are not insurance. Members share costs with each other. Monthly contributions are lower than ACA premiums, and they are not subject to ACA rules.'),
      p('The risks: coverage is not guaranteed, pre-existing conditions are often excluded, sharing is member-discretionary, and there is no regulatory protection if the ministry declines to cover a claim. They can work for healthy people who want catastrophic-only coverage at low cost, but they are not a substitute for real insurance in the face of serious illness.'),
      h2('HSAs: tax-free healthcare savings'),
      p('If you are on a High Deductible Health Plan (HDHP) — either employer-sponsored before retirement or ACA HDHP after — you can contribute to a Health Savings Account (HSA). HSA contributions are:'),
      ul([
        'Tax-deductible (reduces MAGI)',
        'Invested tax-free inside the account',
        'Withdrawn tax-free for qualified medical expenses at any age',
        'Withdrawn penalty-free for any reason at 65 (like a traditional IRA)',
      ]),
      p('The triple tax benefit makes HSAs one of the best savings vehicles available. Front-loading HSA contributions during high-income working years and letting them grow invested — while paying medical bills out of pocket — is a powerful FIRE strategy.'),
      h2('Budget how much to expect'),
      p('Rough healthcare budget benchmarks for early retirees (2024 US dollars):'),
      ul([
        'Healthy single person, 40s–50s, with ACA subsidies: $150–$400/month in premiums',
        'Couple, 50s, with ACA subsidies: $300–$800/month',
        'Without subsidies (income too high): $600–$1,200/month for one person, $1,500–$2,500 for a couple',
        'Add $2,000–$5,000 annual budget for deductibles, copays, and dental/vision',
      ]),
      p('Healthcare is the budget line most likely to surprise early retirees. Model it explicitly, with a range — optimistic (subsidies apply), base, and pessimistic (no subsidies, higher costs) — rather than a single estimate.'),
    ],
  },
  {
    slug: 'social-security-and-fire-when-to-claim',
    title: 'Social Security and FIRE: When to Claim and How to Factor It In',
    description: 'How early retirees should think about Social Security — whether to claim early or late, how to estimate your benefit, and whether to count it in your FIRE number.',
    category: 'Planning',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('Why Social Security matters for FIRE planners'),
      p('Social Security is not just a traditional retirement concept — it is a longevity-adjusted income stream that every paid worker will eventually be eligible for. For FIRE planners, the question is not whether to take Social Security, but how to factor it into portfolio sizing and withdrawal strategy.'),
      p('Even if you retire at 40, you have likely built meaningful Social Security credits through years of working. A few years of high earnings can secure a surprisingly large benefit. And because Social Security is inflation-indexed and paid for life, it is one of the most valuable financial assets many people will ever own.'),
      h2('How your benefit is calculated'),
      p('Social Security benefits are based on your 35 highest earning years (adjusted for wage inflation). If you retire early with fewer than 35 years of earnings, zero-earning years are averaged in, which reduces your benefit.'),
      p('Example: you work 20 years at high income, then retire at 40. Social Security will average those 20 years of earnings and 15 years of zeros. Your benefit will be lower than if you had worked 35 years, but not zero. Many early retirees are surprised by how significant their benefit is even with a short career.'),
      p('You can check your estimate at ssa.gov — the SSA provides projections at 62, full retirement age (66–67 depending on birth year), and 70.'),
      h2('The claiming age trade-off: 62 vs full retirement age vs 70'),
      p('Social Security benefits grow significantly with age:'),
      ul([
        'Claim at 62: receive roughly 70–75% of your full retirement benefit',
        'Claim at full retirement age (66–67): receive 100%',
        'Claim at 70: receive roughly 124–132% of full retirement benefit',
      ]),
      p('The break-even point between claiming at 62 vs 70 is approximately age 80 — if you live past 80, waiting to claim 70 typically yields more lifetime income. If you expect to die before 80 (due to health), claiming early has some logic.'),
      h2('Why most early retirees should wait'),
      p('For FIRE planners, waiting to claim has two advantages:'),
      ul([
        'Larger benefit: every year you delay between 62 and 70 adds 6–8% to your annual benefit. Waiting from 62 to 70 increases the monthly payment by roughly 75%.',
        'Reduces portfolio dependency in later life: a higher guaranteed income stream in your 70s and 80s reduces the risk that portfolio depletion in late life leaves you short. Since sequence-of-returns risk is most dangerous in early retirement, the ideal pattern is to draw heavily from the portfolio in early years and then transition to Social Security as the primary income in later years.',
      ]),
      p('The optimal strategy for most early retirees: spend down the portfolio (and Roth ladder, taxable accounts) from age 40–70, then let Social Security cover a large fraction of spending from 70 onward. This is sometimes called the "two-phase" retirement model.'),
      h2('Should you include Social Security in your FIRE number?'),
      p('This is the most contested planning question. Options:'),
      ul([
        'Exclude it entirely from FIRE planning: most conservative. Your FIRE number covers 100% of spending indefinitely. Social Security becomes a bonus that improves outcomes rather than something you depend on.',
        'Include it as a partial offset: calculate how much your expected Social Security benefit at 70 covers, and reduce your FIRE portfolio target by 25× that amount. Balances conservatism with realism.',
        'Use it as the primary floor: plan to draw on the portfolio heavily until 70, then rely on Social Security for base expenses. Most efficient, but most dependent on the program remaining solvent.',
      ]),
      p('The majority of early FIRE practitioners take the conservative approach — exclude Social Security, reach FIRE independently, then treat Social Security as a margin of safety. Given political uncertainty about future benefits, this is the safest posture for long-horizon early retirees.'),
      h2('The spousal benefit and divorce rules'),
      p('Married couples can claim benefits on each other\'s records. A spouse who earned less (or nothing) is entitled to 50% of the higher-earning spouse\'s benefit, if that is larger than their own earned benefit.'),
      p('For FIRE households where one partner did not work or earned significantly less, this can meaningfully increase the household Social Security income in retirement.'),
      h2('What to do today'),
      p('If you are on the FIRE path and years away from collecting Social Security: create a ssa.gov account, download your earnings statement, and note your benefit projection at age 70. Run your FIRE number two ways — with and without Social Security as a floor — and use that range to understand your margin of safety.'),
    ],
  },
]
...
const articleMetaBySlug: Record<string, LearnArticleMeta> = {
  ...
  'healthcare-before-medicare-early-retirement': {
    primaryStage: 'approaching-fire',
    secondaryStages: ['living-in-fire'],
    relatedCalculators: [
