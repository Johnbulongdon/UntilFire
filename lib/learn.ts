...
export const learnArticles: LearnArticle[] = [
  ...
  {
    slug: 'fire-for-couples-dual-income-shared-timeline',
    title: 'FIRE for Couples: How to Plan Financial Independence Together',
    description: 'How to calculate FIRE as a household, handle different financial situations and timelines between partners, and navigate the decisions that couples face on the path to financial independence.',
    category: 'Planning',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('Why couples have a structural FIRE advantage'),
      p('Two incomes with one set of shared fixed costs is the most powerful natural accelerator for financial independence. A couple earning $180,000 combined and spending $70,000 saves $110,000 per year — a 61% savings rate. The same two individuals living separately might each earn $90,000 and spend $55,000, saving only $35,000 each ($70,000 combined) at a much lower rate.'),
      p('Shared housing, transportation, utilities, and insurance costs mean that two people living together spend far less per capita than two people living separately. This structural advantage compounds over the FIRE timeline.'),
      h2('Calculating the household FIRE number'),
      p('The household FIRE calculation uses combined spending, not individual spending. Add all joint expenses (rent/mortgage, shared food, utilities, insurance, subscriptions) and each partner\'s personal spending (clothing, individual travel, hobbies). The total is the household annual spending; multiply by 25 for the FIRE number.'),
      p('The portfolio is combined too: total all investment accounts across both partners. Track progress as a unified household net worth, not separately.'),
      h2('Different financial starting points'),
      p('Couples rarely start from equal positions. One partner may have student loans; the other may have significant savings. One may earn twice the other\'s salary. These asymmetries require explicit coordination:'),
      ul([
        'Debt: decide together whether to pay off debt first or invest. The partner with high-interest debt (> 7%) should prioritise payoff; if debt is under 4%, investing may be the better joint decision.',
        'Income disparity: the higher earner\'s savings rate is more powerful. Ensure the higher earner is maximising tax-advantaged contributions first (401k, IRA), before directing excess income to taxable accounts.',
        'Savings history: a partner with existing investments brings the household closer to FIRE immediately. Calculate the starting point honestly — combine all investable assets.',
      ]),
      h2('Different timelines: when one partner wants to retire first'),
      p('A common real-world scenario: one partner is 5 years older, or has a higher-stress job, or earns significantly more and wants to stop working sooner. This creates a "rolling retirement" pattern where one partner stops working while the other continues.'),
      p('The math works if the continuing partner\'s income covers household expenses or allows continued saving. The retired partner brings non-financial value (managing the household, caring for children or parents, handling logistics) that frees the working partner from spending on those services. Household productivity can increase.'),
      p('The risk: financial dependence. If the relationship ends while one partner has been out of the workforce for years, that partner faces re-entry with outdated skills and a resume gap. FIRE-for-one planning works best when both partners have their own financial identity maintained — their own accounts, their own Social Security credits, their own financial literacy.'),
      h2('Financial communication and shared planning'),
      p('The most common cause of FIRE plan failure for couples is not math — it is misalignment. One partner is intensely focused on early retirement; the other values current lifestyle more. Differences in spending philosophies, risk tolerance, or retirement vision create chronic friction.'),
      p('Practical approaches:'),
      ul([
        'Monthly money meetings: 30 minutes per month to review spending, net worth progress, and FIRE timeline. Shared data reduces conflict.',
        'Separate fun money: each partner has a personal spending allocation that requires no justification to the other. This preserves autonomy within a joint plan.',
        'Shared vision document: articulate what you are working toward in concrete terms — where you will live, what early retirement looks like, what you will do. Vague goals create disagreement; concrete shared visions create alignment.',
        'Revisit the plan annually: income, spending, and life priorities change. An annual recalculation of the FIRE timeline keeps both partners current.',
      ]),
      h2('Account strategy for couples'),
      p('Both partners should be maximising their own 401(k) contributions (up to the employer match at minimum, ideally to the full limit). Roth IRA contributions should be maximised for both where eligible. Joint taxable brokerage accounts work for shared goals; individual Roth IRAs maintain individual financial identity.'),
      p('Beneficiary designations matter: ensure all accounts have updated beneficiaries. A 401(k) with a previous partner named as beneficiary overrides a will.'),
    ],
  },
  {
    slug: 'asset-location-tax-efficient-investing',
    title: 'Asset Location: Putting the Right Investments in the Right Accounts',
    description: 'How to reduce your lifetime tax bill by placing bonds in tax-deferred accounts, stocks in Roth accounts, and managing taxable brokerage holdings for maximum tax efficiency.',
    category: 'Tax Strategy',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('Asset allocation vs asset location'),
      p('Asset allocation is what you own (60% stocks, 40% bonds). Asset location is where you hold it across your different account types. Both matter — but most investors spend years perfecting allocation while ignoring the significant tax savings available from thoughtful location.'),
      p('The core principle: different assets generate different types of taxable income. Bonds generate interest income, taxed as ordinary income (up to 37%). Stocks generate dividends and capital gains, taxed at more favorable rates. Assets that generate highly taxed income should sit in tax-advantaged accounts where that income is sheltered.'),
      h2('The basic asset location framework'),
      p('Optimal placement, in order of priority:'),
      ul([
        'Tax-deferred accounts (traditional 401k, traditional IRA): best for bonds, REITs, and high-dividend stocks. Interest income and ordinary dividends are sheltered here from annual taxation. Also good for actively managed funds that generate frequent taxable distributions.',
        'Roth accounts (Roth IRA, Roth 401k): best for assets with the highest expected long-term growth — small cap stocks, international stocks, total stock market index. Growth is permanently tax-free.',
        'Taxable brokerage: best for tax-efficient assets — total market index funds (low turnover, minimal distributions), municipal bonds (federally tax-exempt), I Bonds, and individual stocks you plan to hold long-term for favorable capital gains rates.',
      ]),
      h2('Why bonds belong in tax-deferred accounts'),
      p('A bond fund paying 4% interest generates $4,000 per year on a $100,000 holding. In a taxable account, that $4,000 is taxed as ordinary income — at 22% or 24% for most households, leaving $3,040–$3,120. In a traditional IRA, the full $4,000 compounds without annual taxation. The difference, compounded over 20 years, is substantial.'),
      p('Moving $50,000 in bonds from a taxable account to a traditional IRA (and an equivalent $50,000 in stocks from the IRA to taxable) does not change your overall allocation. It just reduces the annual tax drag on the bond interest.'),
      h2('Why Roth accounts are best for high-growth equities'),
      p('The Roth account\'s tax-free growth is most valuable for assets expected to grow the most. A small-cap stock fund that triples in value inside a Roth IRA generates no tax on that growth — ever. The same fund in a traditional IRA defers tax; in a Roth it eliminates it.'),
      p('When building the Roth account over your career, prioritise your highest-expected-return, highest-volatility equity positions there. The combination of long time horizon and tax-free compounding is the most powerful wealth-building combination available.'),
      h2('Managing taxable accounts tax-efficiently'),
      p('For assets that must be in a taxable account, tax efficiency matters:'),
      ul([
        'Index funds over active funds: index funds have low portfolio turnover, generating minimal capital gains distributions. Actively managed funds frequently distribute gains to shareholders, creating tax bills regardless of whether you sold.',
        'Tax-loss harvesting: when holdings are down, sell and buy a similar fund. Lock in the tax loss, stay invested, reduce your annual tax bill.',
        'Hold individual positions long-term: short-term gains (held under 1 year) are taxed at ordinary income rates. Long-term gains (held over 1 year) are taxed at 0%, 15%, or 20%. Never sell a winning position in under a year.',
        'Avoid high-dividend stocks in taxable: dividend income is taxable in the year received. Total market index funds distribute modest dividends; high-dividend funds generate more annual tax exposure.',
      ]),
      h2('The practical implementation'),
      p('If you are just starting out or have a simple portfolio, do not overcomplicate this. The basic rule covers most of the benefit: put bonds and REITs in your 401k or traditional IRA; put stocks in your Roth IRA and taxable accounts. This single adjustment, maintained consistently, saves thousands over a FIRE timeline without requiring complex management.'),
      p('Review asset location annually when rebalancing — not more frequently. The location decisions are a setup task, not an ongoing activity.'),
    ],
  },
  {
    slug: 'spending-audit-find-your-savings-rate-gains',
    title: 'The Spending Audit: How to Find Your Savings Rate Gains',
    description: 'A practical method for reviewing and categorizing expenses to find the specific cuts that move your savings rate — without a painful month-by-month budget.',
    category: 'Planning',
    publishedAt: '2026-06-18',
    readTime: '5 min read',
    body: [
      h2('Why most budgets fail'),
      p('The traditional budget — tracking every dollar category monthly for the rest of your life — works for some people and fails for most. It fails because it is high-friction, requires discipline on every transaction, and creates constant anxiety rather than clarity.'),
      p('The spending audit is different: a one-time, annual review that identifies the structural changes worth making, rather than monitoring every cup of coffee. Do it once per year, implement the changes that make sense, then largely forget about it until next year.'),
      h2('Step 1: pull 3 months of transactions'),
      p('Download or export the last 3 months of transactions from every account: checking, savings, and all credit cards. Most banks provide CSV exports. The goal is a complete picture of where money went — not a partial view from one account.'),
      p('If you have a partner, combine both partners\' accounts. The household spending picture is what matters for FIRE planning.'),
      h2('Step 2: categorize into 8 buckets'),
      p('Sort transactions into these 8 categories — do not get more granular for the audit:'),
      ul([
        'Housing: rent or mortgage, utilities, insurance, property tax, repairs',
        'Transportation: car payment, insurance, fuel, parking, transit',
        'Food: groceries + dining out (keep these together for now)',
        'Healthcare: premiums, copays, prescriptions',
        'Subscriptions: streaming, software, memberships, gym, phone',
        'Debt payments: student loans, credit card minimums, personal loans',
        'Savings and investments: 401k contributions, IRA, brokerage transfers',
        'Everything else: clothing, entertainment, personal, gifts, travel',
      ]),
      h2('Step 3: calculate the monthly average per category'),
      p('Sum each category across the 3 months and divide by 3. This gives your monthly average by bucket. Compare against your take-home income:'),
      ul([
        'What percentage goes to fixed costs (housing + transportation + debt)?',
        'What is your current savings rate (savings + investments / take-home)?',
        'Which category is the largest surprise?',
      ]),
      p('Most people doing this for the first time find that subscriptions are 2–3× what they estimated, food is higher than expected, and transportation is the second-largest category after housing.'),
      h2('Step 4: identify the three highest-leverage cuts'),
      p('The audit\'s purpose is action, not awareness. Find the three changes most worth making:'),
      ul([
        'Subscription audit: cancel everything unused or under-used. Re-subscribe only to what you genuinely miss after a month. This takes 30 minutes and often saves $100–$300/month.',
        'Food split: separate groceries from dining out. If dining out exceeds groceries by more than 50%, that is the highest-ROI behavioral change available.',
        'Structural costs: housing and transportation are harder to change but offer the largest savings. Could you move somewhere $400/month cheaper? Could you eliminate a car payment? These require planning but are year-changing decisions.',
      ]),
      h2('Step 5: calculate the FIRE impact'),
      p('Take each potential cut and run the FIRE math. Saving $300/month is $3,600/year. At 4% withdrawal rate, $3,600/year less spending reduces the required portfolio by $90,000. At a $40,000/year savings rate, that $90,000 is more than 2 additional years of work eliminated by a spending change.'),
      p('This reframe — every dollar less in annual spending removes $25 from the required portfolio — makes spending decisions feel materially different. It is not about frugality for its own sake; it is about the direct trade between current spending and years of work.'),
      h2('Frequency and follow-through'),
      p('Do the full spending audit once per year, typically in January using the prior year\'s data. Between audits, track only the categories you changed — a single line item check rather than full transaction monitoring. This balances awareness with the cognitive load of constant tracking.'),
      p('Most people find that 2–3 targeted changes from the first audit add 3–5 percentage points to their savings rate permanently, without feeling meaningfully more constrained.'),
    ],
  },
]
...
const articleMetaBySlug: Record<string, LearnArticleMeta> = {
  ...
  'fire-for-couples-dual-income-shared-timeline': {
    primaryStage: 'building-momentum',
    secondaryStages: ['starting-out', 'approaching-fire'],
    relatedCalculators: [
      { href: '/calculators/savings-rate', label: 'Savings Rate Calculator' },
      { href: '/?source=learn-couples-fire', label: 'FIRE Calculator' },
    ],
  },
  ...
  'spending-audit-find-your-savings-rate-gains': {
    primaryStage: 'starting-out',
    secondaryStages: ['building-momentum'],
    relatedCalculators: [
      { href: '/calculators/savings-rate', label: 'Savings Rate Calculator' },
      { href: '/?source=learn-spending-audit', label: 'FIRE Calculator' },
    ],
  },
}
