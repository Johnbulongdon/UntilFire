...
export const learnArticles: LearnArticle[] = [
  ...
  {
    slug: 'bond-tent-strategy-protecting-early-retirement',
    title: 'The Bond Tent: How to Protect Early Retirement From a Bad Market Start',
    description: 'Why holding more bonds at the moment of retirement — and gradually reducing them over time — is one of the most effective defenses against sequence-of-returns risk.',
    category: 'Investing',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('The vulnerability at the moment of retirement'),
      p('The years immediately before and after you stop working are the most dangerous in your financial life. If the market drops 30% in year 1 or 2 of retirement — while you are drawing $50,000 per year from the portfolio — you are selling shares at depressed prices. Those shares never get a chance to recover. The portfolio is permanently smaller, and future withdrawals take a larger percentage of a smaller base.'),
      p('This is sequence-of-returns risk: the sequence of returns matters enormously, not just the average. Two portfolios with identical average returns over 30 years can have radically different outcomes depending on whether the bad years came first or last.'),
      h2('What a bond tent is'),
      p('A bond tent (also called a rising equity glidepath) is a strategy of holding more bonds than usual during the highest-risk window: the years immediately around the retirement date. As time passes and the risk window closes, you gradually shift back toward a higher equity allocation.'),
      p('The "tent" shape: your bond allocation rises as you approach retirement, peaks at the moment you retire, then gradually declines as you age into mid-retirement and the worst sequence-of-returns years are behind you.'),
      h2('A concrete example'),
      p('A FIRE investor with a target 70/30 allocation (70% stocks, 30% bonds) might use this glidepath:'),
      ul([
        'Age 35–45 (early accumulation): 90% stocks, 10% bonds — maximise growth',
        'Age 45–50 (approaching FIRE): 80% stocks, 20% bonds — begin conservative shift',
        'Age 50 (FIRE date): 60% stocks, 40% bonds — peak bond allocation (the tent top)',
        'Age 50–60 (early retirement): gradually shift back to 70/30 as risk window passes',
        'Age 60+ (stable retirement): maintain 70/30 or adjust to personal comfort',
      ]),
      p('The key insight: the peak bond allocation is at retirement, not at old age. This is the opposite of the traditional "age in bonds" rule, which would have a 50-year-old at 50% bonds — the bond tent approach is more targeted.'),
      h2('Why it works'),
      p('Research by Michael Kitces and Wade Pfau shows that this rising equity glidepath materially improves portfolio survival rates for early retirees. The mechanism:'),
      ul([
        'At retirement (peak risk): the higher bond allocation means fewer equity shares are sold during a downturn. The portfolio survives bad early years with less permanent damage.',
        'In mid-retirement (lower risk): the gradual return to higher equities captures more growth as the time horizon extends and the sequence risk period passes.',
        'The bond tent adds yield and stability in the years you need it most, then gets out of the way.',
      ]),
      h2('How to implement it'),
      p('Practically, the bond tent is implemented through asset allocation decisions in your tax-advantaged accounts. Bonds are best held in traditional IRAs and 401(k)s (where interest income is tax-deferred), while equities are best held in Roth IRAs and taxable accounts (where long-term capital gains are taxed favorably).'),
      p('You do not need to sell everything and rebalance dramatically. The most common approach: stop buying equities with new contributions 5 years before FIRE, redirect contributions to bond funds, and let the portfolio drift toward the higher bond allocation naturally. Then, in retirement, gradually increase equity contributions or rebalance toward stocks each year.'),
      h2('Who should use a bond tent'),
      p('The bond tent is most valuable for:'),
      ul([
        'Early retirees (FIRE before 55) with 50+ year time horizons where sequence risk is most dangerous.',
        'Retirees without large supplemental income (no Social Security, no pension) who are fully dependent on the portfolio.',
        'Retirees with moderate spending flexibility — the tent strategy works best alongside a willingness to cut spending modestly in a down year.',
      ]),
      p('If you have significant guaranteed income (pension, rental, Social Security) that covers most spending, the bond tent is less necessary. The portfolio is not your only safety net.'),
    ],
  },
  {
    slug: 'withdrawal-order-strategy-which-accounts-first',
    title: 'Withdrawal Order Strategy: Which Accounts to Draw From First',
    description: 'The tax-efficient sequence for withdrawing from taxable, traditional, and Roth accounts in retirement — and why order matters as much as the amounts.',
    category: 'Tax Strategy',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('Why withdrawal order matters'),
      p('Most FIRE planners spend years optimizing how to accumulate wealth. Far fewer think carefully about the tax implications of how they draw it down. The order in which you withdraw from different account types can make a six-figure difference in lifetime tax liability — without changing the total amount you spend.'),
      p('The core tension: different accounts have different tax treatment on withdrawal. Taxable brokerage gains are taxed at favorable long-term capital gains rates. Traditional IRA and 401(k) withdrawals are taxed as ordinary income (up to 37%). Roth IRA withdrawals are tax-free. The order you draw from these determines how much of your spending goes to taxes.'),
      h2('The standard withdrawal order'),
      p('For most early retirees, the conventional sequence is:'),
      ol([
        'Required Minimum Distributions (RMDs) first — if you are 73+, you must take these from traditional accounts regardless of need.',
        'Taxable brokerage accounts — draw here first in early retirement. Long-term capital gains are taxed at 0% for lower incomes (under ~$47,025 single, $94,050 married in 2024). In early retirement with no salary, you may pay nothing on these.',
        'Traditional IRA and 401(k) — draw next. These are taxed as ordinary income. Draw enough to fill lower tax brackets, but not so much that you push into higher brackets.',
        'Roth IRA last — let Roth accounts grow tax-free as long as possible. These are your most valuable long-run assets because all future growth is also tax-free.',
      ]),
      p('This sequence minimizes taxes because you draw from the most favorably taxed source first and preserve the most valuable tax-free accounts for last.'),
      h2('The 0% capital gains window in early retirement'),
      p('For early retirees with low income, the 0% long-term capital gains bracket is one of the most powerful tools available. In 2024, a single filer with taxable income under $47,025 pays 0% federal tax on long-term capital gains. A married couple pays 0% below $94,050.'),
      p('In early retirement, with no salary and modest portfolio withdrawals, many FIRE households fall into this bracket. Selling taxable brokerage shares at a large gain generates no federal tax at all.'),
      p('Strategy: in early retirement years, harvest gains from the taxable account aggressively while you are in the 0% bracket. This resets your cost basis upward, reducing future gains taxes when you eventually move into a higher bracket.'),
      h2('Simultaneous Roth conversions'),
      p('While drawing from taxable accounts in early retirement, many FIRE practitioners simultaneously convert traditional IRA money to Roth IRA money. The goal: fill up the 10% and 12% tax brackets with Roth conversions each year, converting money that would otherwise be taxed at higher rates in later years when RMDs force large withdrawals.'),
      p('Example: annual spending of $50,000 covered by taxable account sales. Additionally, convert $30,000 from traditional IRA to Roth IRA. Total income: $50,000 (of which capital gains may be 0%) + $30,000 Roth conversion (taxed at 10–12%). Tax bill: very low. Result: $30,000 moved from a tax-deferred bucket to a tax-free bucket.'),
      p('This is often called "the gap years strategy" — the low-income years of early retirement are the optimal window to convert.'),
      h2('Account sequencing for married couples'),
      p('Married couples have additional tools:'),
      ul([
        'Both spouses can use the standard deduction, doubling the 0% capital gains income threshold.',
        'If one spouse has a pension or Social Security, draw from the other\'s taxable accounts first.',
        'Consider which spouse\'s traditional IRA to draw from based on who will live longer and face the most RMD exposure.',
        'Inherited IRA rules mean drawing sequence decisions can affect heirs\' tax liability.',
      ]),
      h2('What changes this calculation'),
      p('State income taxes can complicate the order. Some states tax capital gains as ordinary income, making taxable account withdrawals less attractive. Others have no income tax at all.'),
      p('The presence of Social Security matters too — Social Security income is taxed based on total income, so higher withdrawals from traditional accounts can trigger more Social Security taxation, creating an effective marginal tax rate spike known as the "torpedo."'),
      p('Review your withdrawal order every 3–5 years as tax laws, account balances, and income sources shift.'),
    ],
  },
  {
    slug: 'inflation-and-fire-what-it-means-for-your-plan',
    title: 'Inflation and FIRE: What Rising Prices Mean for Your Retirement Plan',
    description: 'How inflation erodes purchasing power, why the 4% rule accounts for it, and what practical adjustments protect a FIRE portfolio against sustained high inflation.',
    category: 'Planning',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('Why inflation is the silent threat'),
      p('A portfolio that survives without inflation may fail with it. Inflation does not show up as a dramatic loss like a market crash — it is a slow, steady erosion of purchasing power that compounds over decades. $50,000 per year in spending today requires $90,000 in 20 years at 3% inflation, and $121,000 in 30 years. The dollar amount stays the same; what it buys shrinks every year.'),
      p('For early retirees facing 50-year horizons, inflation is arguably a bigger long-run threat than a single market crash.'),
      h2('How the 4% rule handles inflation'),
      p('The original 4% rule (Trinity Study) already accounts for inflation. It tested inflation-adjusted withdrawals — meaning you withdraw 4% of the initial portfolio in year 1, then increase that dollar amount each year by the actual inflation rate. The study found portfolios survived this pattern across 95%+ of historical 30-year periods.'),
      p('So the 4% rule is not a fixed dollar withdrawal — it is a fixed real (inflation-adjusted) withdrawal. If you start by withdrawing $50,000 in year 1 and inflation runs 3%, you withdraw $51,500 in year 2, $53,045 in year 3, and so on.'),
      h2('What high inflation does to the plan'),
      p('The 4% rule was calibrated on historical US inflation of roughly 2–3% annually. Sustained inflation significantly above that — like the 7–9% seen in 2021–2023 — creates several compounding problems:'),
      ul([
        'Withdrawal amounts grow faster than anticipated, drawing down the portfolio more quickly.',
        'Bond values fall when inflation spikes (since new bonds offer higher yields, old bonds are worth less). A 60/40 portfolio can lose on both sides simultaneously during an inflationary period.',
        'TIPS (Treasury Inflation-Protected Securities) and I Bonds are the main hedges, but they offer lower expected real returns than equities.',
        'Fixed expenses — especially healthcare and housing — often inflate faster than the general CPI.',
      ]),
      h2('Historical inflation in the FIRE context'),
      p('Over the long run, US inflation has averaged roughly 2.5–3% annually. The periods that tested retirement portfolios most severely were the 1970s (stagflation, ~7% average inflation over the decade) and the recent 2021–2023 spike. Both were eventually followed by lower inflation — but the damage to early retirees who started withdrawing during those periods was real.'),
      p('The Shiller CAPE-based research suggests that high starting equity valuations paired with high inflation is the most dangerous combination for retirement portfolios. Both conditions together — not just one — correlate most strongly with poor 30-year outcomes.'),
      h2('Practical inflation hedges for FIRE portfolios'),
      p('Inflation protection does not require exotic instruments. The most practical approaches:'),
      ul([
        'Equities are the best long-run inflation hedge. Companies adjust prices, raise revenues, and retain real value over time. Holding a diversified global equity index naturally hedges against broad inflation.',
        'TIPS (Treasury Inflation-Protected Securities): the principal adjusts with CPI, so they provide explicit inflation protection on the bond portion of the portfolio.',
        'I Bonds: US savings bonds that pay a fixed rate plus CPI inflation adjustment. Annual purchase limit of $10,000 per person. Good for cash reserves and emergency funds.',
        'Real assets: real estate equity (including primary home) tends to hold value in inflationary environments. REITs provide this exposure without direct ownership.',
        'Short bond duration: long-duration bonds are most hurt by inflation. Holding shorter-duration bonds (2–5 year) reduces sensitivity to inflation-driven rate spikes.',
      ]),
      h2('Spending flexibility as the best hedge'),
      p('Research consistently shows that spending flexibility — the ability to reduce withdrawals by 10–20% in years of high inflation or poor markets — is the single most effective protection against both inflation and sequence risk. A rigid withdrawal strategy that ignores what the portfolio is doing will eventually fail in a severe enough scenario.'),
      p('The practical version: have a personal "floor" of essential spending and a "ceiling" of comfortable spending. In a high-inflation year, cut toward the floor. In a low-inflation, strong-market year, allow spending to rise toward the ceiling. This dynamic range dramatically extends the portfolio.'),
      h2('What a 1% inflation assumption error costs'),
      p('Underestimating inflation has asymmetric costs. If you plan for 2% and experience 3.5% over 30 years, your spending power at retirement end is 35% lower than planned. That is a meaningful shortfall over a long retirement.'),
      p('The conservative approach: model FIRE targets with a 3–3.5% inflation assumption even in low-inflation environments. The extra portfolio buffer costs you 2–3 years of additional saving; the protection against being wrong is worth it.'),
    ],
  },
]
...
const articleMetaBySlug: Record<string, LearnArticleMeta> = {
  ...
  'bond-tent-strategy-protecting-early-retirement': {
    primaryStage: 'approaching-fire',
    secondaryStages: ['living-in-fire'],
    relatedCalculators: [
      { href: '/calculators/4-percent-rule', label: 'Safe Withdrawal Calculator' },
  ...
  'withdrawal-order-strategy-which-accounts-first': {
    primaryStage: 'living-in-fire',
    secondaryStages: ['approaching-fire'],
    relatedCalculators: [
      { href: '/calculators/4-percent-rule', label: 'FIRE Number Calculator' },
  ...
  'inflation-and-fire-what-it-means-for-your-plan': {
    primaryStage: 'approaching-fire',
