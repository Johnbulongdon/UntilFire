...
export const learnArticles: LearnArticle[] = [
  ...
  {
    slug: 'international-investing-why-global-diversification-matters',
    title: 'International Investing: Why Global Diversification Matters for FIRE',
    description: 'The case for holding ex-US stocks, how home country bias silently reduces returns, and the practical approach to adding international exposure to a FIRE portfolio.',
    category: 'Investing',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('Most FIRE investors are overweight the US'),
      p('A typical US investor holds 80–100% of their equity portfolio in US stocks. This is called home country bias — a well-documented tendency to overweight familiar domestic investments. While the US has produced exceptional returns over the past decade, concentrating entirely in one country is a form of geographic concentration risk.'),
      p('The US represents roughly 60% of global stock market capitalisation. Holding only US stocks means ignoring 40% of the world\'s investable equity. Countries like Japan, Germany, the UK, Canada, and emerging markets like India and China all have market cycles that do not perfectly track the US. Global diversification smooths out periods when US markets underperform the rest of the world.'),
      h2('The home country bias trap'),
      p('From 2010 to 2020, US stocks massively outperformed international stocks. Many investors concluded that international diversification was a failed strategy. But this is recency bias — selecting the strategy that looked best in the recent past. From 2000 to 2010, international stocks significantly outperformed the US. No one consistently predicts which geography will lead.'),
      p('Over very long periods, international and US stocks tend to produce similar returns, but with different timing. Holding both reduces the variance of outcomes: you give up the chance of capturing the best decade in the best market in exchange for avoiding the worst outcomes in the worst markets.'),
      h2('Practical international funds for FIRE investors'),
      ul([
        'VXUS (Vanguard Total International Stock ETF) — covers 7,900+ companies outside the US across developed and emerging markets. Expense ratio: 0.07%.',
        'VTIAX (Vanguard Total International Stock Index Fund) — same as VXUS, mutual fund share class. Minimum $3,000.',
        'VEA (Vanguard FTSE Developed Markets ETF) — developed markets only, excludes emerging markets for investors who want to limit volatility. Expense ratio: 0.05%.',
        'VWO (Vanguard FTSE Emerging Markets ETF) — emerging markets only. Higher growth potential, higher volatility.',
        'FZILX (Fidelity Zero International Index Fund) — zero expense ratio, international, Fidelity accounts only.',
      ]),
      h2('How much international exposure is appropriate?'),
      p('There is no single right answer, but common recommendations range from 20% to 40% of the equity portion of a portfolio in international stocks. The global market weight approach — roughly 40% international to match global market capitalisation — is a principled default.'),
      p('Many FIRE investors split their equity allocation 70/30 US to international. Others go 60/40. Below 20% international, the diversification benefit becomes minimal. Above 50% international, you are making an active bet against the US, which requires conviction.'),
      h2('The currency risk reality'),
      p('International funds carry currency risk — when the US dollar strengthens, returns from foreign markets are reduced in dollar terms. This is a real risk, but it cuts both ways: when the dollar weakens, international returns are amplified. Over long periods, currency fluctuations tend to average out. Hedged international funds (like HEFA) reduce currency risk but add cost and complexity. Most FIRE investors accept the unhedged exposure.'),
      h2('Dividends and foreign tax withholding'),
      p('International stocks pay dividends that are subject to foreign withholding taxes — typically 15–25% depending on the country. In a taxable account, you can claim a foreign tax credit on your US return, recovering most of this. In a Roth IRA, you cannot claim the credit, making international funds slightly less efficient in Roth accounts. This is a small consideration — the diversification benefit still usually justifies the allocation regardless of account type.'),
    ],
  },
  {
    slug: 'fire-glide-path-shifting-from-accumulation-to-withdrawal',
    title: 'The FIRE Glide Path: How Your Portfolio Should Shift Before and After Retirement',
    description: 'How to transition your portfolio from 100% growth to a withdrawal-ready allocation — and why the years just before and after FIRE are the most critical for long-term success.',
    category: 'Planning',
    publishedAt: '2026-06-18',
    readTime: '7 min read',
    body: [
      h2('What is a glide path?'),
      p('A glide path describes the planned shift in portfolio allocation over time — typically from higher-growth, higher-volatility investments early in the accumulation phase toward more stable allocations as retirement approaches. Target-date funds use a predetermined glide path. FIRE investors need to design their own, calibrated to their specific timeline and risk tolerance.'),
      p('The central problem a glide path solves is sequence-of-returns risk: the danger that a major market decline in the first few years of retirement can permanently impair a portfolio even if long-run returns are acceptable. A portfolio that drops 40% in year one of retirement and never fully recovers presents a real risk to a 40-year retirement, even if the historical average return over that period is 7%.'),
      h2('The accumulation phase: growth-heavy is correct'),
      p('During the early and middle accumulation years — while you are a decade or more from FIRE — a high equity allocation (80–100% stocks) is generally optimal. You have time to recover from downturns, and volatility is an ally: market dips allow you to buy more shares at lower prices with each contribution.'),
      p('The common mistake is holding too much cash or bonds during the accumulation phase out of fear. Every year of unnecessarily conservative allocation during a 20-year savings window compounds against you. Over 20 years, the difference between a 6% and 8% annual return on $10,000 invested is approximately $12,000 — on that single contribution alone.'),
      h2('The 5-year danger zone before FIRE'),
      p('Starting roughly five years before your target FIRE date, the balance of risk begins to shift. A major market crash in this window — while you are still working — could force you to either delay FIRE significantly or retire into a damaged portfolio. Two strategies help:'),
      ul([
        'Begin shifting 5–10% of the portfolio toward bonds or cash each year so that by FIRE date you hold 1–2 years of spending in stable assets.',
        'Build a cash buffer separately from your investment portfolio — a dedicated "FIRE transition fund" covering 12–24 months of spending, held in a high-yield savings account.',
      ]),
      p('This does not mean dramatically reducing equity exposure. A 90/10 portfolio shifting to 80/20 over five years is a measured adjustment, not a panic-driven move.'),
      h2('The bond tent: peak bonds at retirement, then rebuild stocks'),
      p('One well-researched approach is the bond tent (also called rising equity glidepath). In this strategy, you increase bond allocation heading into retirement, then gradually sell bonds and increase equities over the first 5–10 years of retirement.'),
      p('The logic: bonds protect against a crash in the years immediately before and after FIRE, when sequence risk is highest. Once 5–10 years of retirement have passed, the risk of permanent impairment from a crash drops significantly — your portfolio has had time to grow, and you have a shorter horizon to fund. Rebuilding equities then recaptures long-run growth potential.'),
      ul([
        'Pre-FIRE peak: 70% stocks / 30% bonds (or 60/40 for very conservative planners)',
        'Year 1–5 post-FIRE: gradually sell bonds, shift toward 80% stocks',
        'Year 10+ post-FIRE: settle at 80–90% stocks for a 30–40 year remaining horizon',
      ]),
      h2('The 2-year cash bucket'),
      p('Many FIRE retirees hold 1–2 years of living expenses in cash (HYSA or money market) separate from the investment portfolio. This bucket is spent first. When markets are up, you refill it by selling investments. When markets are down, you spend from the cash bucket and give the investment portfolio time to recover without forcing sales at depressed prices.'),
      p('The cash bucket does not dramatically change long-run returns — cash earns far less than stocks. But it provides the psychological runway to not panic-sell during downturns, which is arguably worth more than any allocation optimisation for most investors.'),
      h2('After FIRE: no single right allocation'),
      p('Once in retirement, the optimal allocation depends on spending flexibility, other income sources, and emotional tolerance for volatility. A retired couple with $30,000 in Social Security income and $50,000 in annual spending only needs the portfolio to cover $20,000 per year — they can afford much more equity exposure than a couple with zero outside income. Model your situation specifically rather than applying a one-size rule.'),
    ],
  },
  {
    slug: 'hsa-health-savings-account-triple-tax-advantage',
    title: 'HSA: The Triple Tax Advantage Account FIRE Investors Should Max First',
    description: 'How a Health Savings Account provides the best tax deal available — contributions, growth, and withdrawals all tax-free — and how to use it as a stealth retirement account on the FIRE path.',
    category: 'Tax Strategy',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('What is a Health Savings Account?'),
      p('A Health Savings Account (HSA) is a tax-advantaged account available to people enrolled in a High Deductible Health Plan (HDHP). It is the only account in the US tax code that offers a triple tax advantage: contributions are tax-deductible, growth inside the account is tax-free, and withdrawals for qualified medical expenses are tax-free. No other account type — not a 401k, not a Roth IRA — offers all three benefits simultaneously.'),
      h2('The triple tax advantage in practice'),
      ul([
        'Tax deduction on contributions: contributing $4,150 (2024 individual limit) reduces your taxable income by $4,150. At a 22% tax bracket, that is $913 in immediate tax savings.',
        'Tax-free growth: investments inside the HSA compound without annual taxation on dividends or capital gains.',
        'Tax-free withdrawals for medical expenses: at any point — today or in 30 years — you can withdraw tax-free for qualified medical costs including deductibles, prescriptions, dental, vision, and many other expenses.',
      ]),
      p('After age 65, HSA withdrawals for non-medical expenses become taxable as ordinary income — the same as a traditional 401k. This makes the HSA function as a traditional IRA floor: worst case, it is treated like a 401k after 65. Best case, medical expenses in retirement use it completely tax-free.'),
      h2('2024 contribution limits'),
      ul([
        'Individual coverage HDHP: $4,150',
        'Family coverage HDHP: $8,300',
        'Catch-up contribution (age 55+): additional $1,000',
      ]),
      p('Contributions can be made until the tax filing deadline (typically April 15 of the following year), giving you time to maximise contributions after seeing your final tax picture.'),
      h2('The invest-and-hold strategy for FIRE'),
      p('Most HSA holders use their account like a medical flexible spending account: contribute, spend on healthcare, repeat. This wastes the triple tax advantage. The optimal FIRE strategy is to invest the HSA in low-cost index funds and never touch it during the accumulation phase.'),
      p('Instead of reimbursing yourself for medical expenses immediately, pay out of pocket from your regular cash flow and keep a folder of all qualified receipts. There is no time limit on HSA reimbursements — you can submit a receipt from 10 years ago for reimbursement today. This means your medical receipts function as a future withdrawal mechanism: a tax-free cash extraction right you can exercise whenever needed in early retirement.'),
      h2('Why the HSA often beats the Roth IRA'),
      p('For FIRE investors who can only afford to max one account, the HSA often edges out the Roth IRA:'),
      ul([
        'HSA contributions reduce taxable income (Roth contributions do not).',
        'HSA growth is tax-free (same as Roth).',
        'Medical withdrawals are tax-free (same as Roth for qualified distributions).',
        'Non-medical withdrawals after 65 are taxable (same as traditional 401k — better than nothing).',
        'You will have medical expenses in retirement — the HSA is the only account that lets you pay those completely tax-free.',
      ]),
      h2('HDHP eligibility and the trade-off'),
      p('To contribute to an HSA you must be enrolled in a qualifying High Deductible Health Plan. HDHPs require a minimum deductible of $1,600 individual / $3,200 family (2024) and have out-of-pocket maximums of $8,050 individual / $16,100 family. They typically have lower premiums than PPO plans, making them cost-effective for healthy individuals and families who do not expect high medical utilisation.'),
      p('The right question is not "is an HSA good?" — the triple tax advantage is clearly valuable. The right question is whether an HDHP makes sense given your health situation and expected medical spending. For many FIRE investors in their 30s and 40s with manageable health costs, the math usually favours the HDHP-plus-HSA combination.'),
      h2('Investing inside the HSA'),
      p('Most HSA providers offer investment options once your balance exceeds a threshold (commonly $1,000–$2,000). Choose low-cost index funds matching your regular investment strategy. The same total-market index fund logic applies: Fidelity, Lively, and HSA Bank all offer competitive investment menus with low-cost Vanguard or Fidelity index fund options. Avoid HSAs that charge high monthly fees or offer only high-expense funds — the triple tax advantage can be eroded by poor fund selection.'),
    ],
  },
]
...
const articleMetaBySlug: Record<string, LearnArticleMeta> = {
  ...
  'international-investing-why-global-diversification-matters': {
    ...
    relatedCalculators: [
      { href: '/calculators/compound-interest', label: 'Compound Interest Calculator' },
      { href: '/?source=learn-international', label: 'FIRE Calculator' },
    ],
  },
  'fire-glide-path-shifting-from-accumulation-to-withdrawal': {
    primaryStage: 'approaching-fire',
    secondaryStages: ['living-in-fire'],
    relatedCalculators: [
      { href: '/calculators/4-percent-rule', label: 'FIRE Number Calculator' },
