...
export const learnArticles: LearnArticle[] = [
  ...
  {
    slug: 'how-to-find-money-to-save',
    title: 'How to Find Money to Save: Uncovering Your Budget Leaks',
    description: 'Most people can save more than they think. Here\'s how to find the hidden money in your budget without deprivation.',
    category: 'Saving',
    publishedAt: '2026-06-17',
    readTime: '6 min read',
    body: [
      h2('The truth: most savings come from finding leaks, not cutting hard'),
      p('People often think FIRE requires deprivation — cutting to beans and rice. In reality, most people can find 10–20% more in monthly savings just by plugging leaks and eliminating things they do not value. You are not depriving yourself; you are reallocating money from things you forgot you were paying for.'),
      h2('The three categories of spending leaks'),
      p('Audit your bank and credit card statements from the last 3 months and categorize every transaction:'),
      ul([
        'Forgotten subscriptions — Netflix, Spotify, gym memberships, apps you used once and forgot about',
        'Lifestyle inflation — you upgraded your coffee, eat out more often, or buy premium versions without noticing',
        'Invisible defaults — recurring charges that were set up years ago (insurance, phone plan, etc.)',
      ]),
      h2('The audit process'),
      ol([
        'Download 3 months of transactions (all cards, bank accounts, PayPal, Venmo, etc.)',
        'Sort by merchant or category — group similar businesses together',
        'Highlight anything you do not recognise or do not value',
        'Calculate the monthly cost of each leak',
        'Total them up — this is your "free" savings',
      ]),
      p('Most people find $200–$500/month in leaks. At a 7% annual return, finding $300/month in leaks accelerates your FIRE date by 2–3 years.'),
      h2('High-impact categories to audit'),
      ul([
        'Subscriptions & memberships — streaming, productivity apps, dating apps, LinkedIn Premium, etc. (average household: $150/month)',
        'Eating out & food delivery — easy to creep up; categorise whether this adds value',
        'Insurance — phone plan, car insurance, home insurance; often overpriced after years of loyalty',
        'Transportation — car payment, gas, parking, tolls, rideshare; can compound into thousands',
        'Fitness & wellness — gym, yoga, apps; often used < 10% of the year',
      ]),
      h2('The "value test"'),
      p('After identifying a leak, ask: "Would I buy this again today if I had to choose?" If no, cut it. If yes, keep it. But be honest — most subscriptions fail this test.'),
      h2('Automation: make cutting effortless'),
      p('Once you identify leaks:'),
      ul([
        'Cancel immediately (do not wait)',
        'Set a phone reminder to audit subscriptions quarterly',
        'Route the freed-up money directly to a savings account (automate the win)',
      ]),
      h2('The psychology of painless savings'),
      p('Cutting leaks feels better than cutting necessities because you are not depriving yourself — you are removing things you forgot you were paying for. This is why most people can sustain 10–20% savings rate increases when they focus on leaks first, then lifestyle changes.'),
    ],
  },
  {
    slug: 'behavioral-finance-why-you-sabotage-your-fire-plan',
    title: 'Behavioral Finance: Why You Self-Sabotage Your FIRE Plan',
    description: 'Understanding the psychology behind financial self-sabotage — loss aversion, lifestyle inflation, and decision fatigue — and how to protect your plan.',
    category: 'Saving',
    publishedAt: '2026-06-17',
    readTime: '7 min read',
    body: [
      h2('You are not rational with money — and that is the problem'),
      p('Classical economics assumes you make rational decisions. In reality, your brain has deep evolutionary biases that make you sabotage your own FIRE plan. Understanding these biases is the first step to overcoming them.'),
      h2('Loss aversion: losing $100 hurts more than gaining $100 feels good'),
      p('Studies show that losing money generates roughly 2× the emotional pain of the equivalent gain. This is loss aversion. It means that when your portfolio drops 10% in a downturn, the pain feels enormous — even though the long-term math says hold steady and it will recover.'),
      p('How it sabotages FIRE: panic selling during crashes, keeping too much in cash, or avoiding stock investing entirely.'),
      p('How to protect yourself:'),
      ul([
        'Automate contributions — if money moves without your input, you avoid emotional decision-making',
        'Hide your portfolio — check it 1–2 times per year, not daily',
        'Remember that downturns are features, not bugs — they force you to "buy low"',
      ]),
      h2('Lifestyle inflation: as income grows, so does spending'),
      p('When you get a raise, bonus, or tax refund, you do not consciously decide to spend it. Instead, it vanishes into higher rent, fancier restaurants, or upgraded gadgets. This is lifestyle inflation. It erodes your savings rate without you noticing.'),
      p('How it sabotages FIRE: you earn 20% more but save the same amount, so your timeline extends.'),
      p('How to protect yourself:'),
      ul([
        'Automate savings immediately — move 50% of any raise directly to savings before you can spend it',
        'Track your net worth monthly — if it is not growing, your lifestyle inflation is running you',
        'Draw a "freedom line" — below this spending level, you stay on track; above it, you add years to your timeline',
      ]),
      h2('Present bias: today is worth more than tomorrow'),
      p('Your brain discounts the future heavily. Skipping $5 coffee today is worth 10 cents to your future-self, but your present-self weighs it as a real cost right now. This is why FIRE is psychologically hard — the pain is immediate, the benefit is years away.'),
      p('How it sabotages FIRE: you spend money today because the future feels abstract and distant.'),
      p('How to protect yourself:'),
      ul([
        'Make the future concrete — use a FIRE calculator to see your exact retirement date, not a vague "someday"',
        'Make savings automatic — remove the daily decision-making',
        'Find small wins along the way — celebrate milestones ($100k, $250k, etc.) to make progress tangible',
      ]),
      h2('Anchoring: the first number you see sticks'),
      p('When you see a price, salary, or portfolio return, your brain anchors to that number. If a broker says "most people earn 8% returns," you anchor to 8% even if history suggests 6–7%.'),
      p('How it sabotages FIRE: you build a plan on anchored assumptions (8% returns, low inflation) that do not match reality.'),
      p('How to protect yourself:'),
      ul([
        'Stress-test your plan with conservative assumptions (6% returns, higher inflation)',
        'Read multiple sources before forming a belief',
        'Run your plan at 3 different return assumptions and see the range',
      ]),
      h2('The cure: systems over willpower'),
      p('You cannot willpower your way to FIRE. Instead, build systems that do the right thing automatically:'),
      ul([
        'Automate contributions and investing',
        'Hide portfolio details to avoid emotional checking',
        'Lock savings into separate accounts or investment accounts',
        'Use FIRE calculators to visualise the future concretely',
        'Find an accountability partner or community',
      ]),
      p('When behavior is automatic, psychology becomes irrelevant.'),
    ],
  },
  {
    slug: 'emergency-fund-vs-debt-payoff-priority-framework',
    title: 'Emergency Fund vs Debt Payoff: Which Should You Prioritize?',
    description: 'A decision framework for choosing between building an emergency fund and paying off debt — depends on interest rate, stability, and peace of mind.',
    category: 'Saving',
    publishedAt: '2026-06-17',
    readTime: '5 min read',
    body: [
      h2('The emergency fund vs debt payoff dilemma'),
      p('You have extra money each month. Should you build an emergency fund first or pay down debt? The answer is: it depends. Here is the framework to decide.'),
      h2('The interest-rate rule: pay high-rate debt first'),
      p('If your debt interest rate is significantly higher than your investment returns, paying debt is a guaranteed return.'),
      ul([
        'Credit card debt at 18–22% → pay this before emergency fund',
        'Personal loan at 8–12% → consider paying before emergency fund',
        'Student loans at 4–6% → emergency fund first, then debt payoff',
        'Mortgage at 3–5% → emergency fund first, then slow debt payoff',
      ]),
      p('The math: paying off 18% credit card debt is a guaranteed 18% return. Investing for 7% returns is not as good. Pay credit card debt aggressively.'),
      h2('The stability rule: emergency fund first if job is unstable'),
      p('Interest rate is not the only factor. Your income stability matters.'),
      ul([
        'Stable income (government job, tenured position) → build modest emergency fund, then attack debt',
        'Volatile income (freelance, commission-based, early startup) → build full emergency fund first, then debt payoff',
        'Recently employed or in probation → full emergency fund first',
      ]),
      p('Why: if you lose your job with no emergency fund, you end up taking on even higher-interest debt (payday loans, credit cards) just to survive. A full emergency fund prevents this trap.'),
      h2('The peace-of-mind rule: emergency fund first if debt causes anxiety'),
      p('Some people obsess over small debts. Others sleep fine owing $50k. Psychologically:'),
      ul([
        'High debt anxiety → build emergency fund to reduce overall financial stress, then tackle debt',
        'Low debt anxiety → build modest emergency fund, then aggressively pay debt',
      ]),
      p('You cannot optimize your FIRE plan if you are stressed. Prioritise peace of mind.'),
      h2('A practical framework'),
      ol([
        'If credit card or high-interest debt (12%+) → put 50% toward emergency fund, 50% toward debt payoff',
        'If lower-interest debt (under 8%) + stable income → build full emergency fund, then attack debt',
        'If lower-interest debt + unstable income → build full emergency fund first',
        'Emergency fund target: 3–6 months of expenses (3 if stable, 6 if volatile)',
      ]),
      h2('Once emergency fund is built'),
      p('With a full emergency fund in place, redirect all extra money to debt payoff. The guaranteed return beats market returns for most debt rates.'),
      p('Exception: 401k matching and Roth IRA contributions always come first (free money). After those, focus on high-interest debt.'),
    ],
  },
  {
    slug: 'the-50-30-20-rule-and-fire',
    title: 'The 50/30/20 Rule and FIRE: A Simple Budget Framework',
    description: 'A simple spending framework (50% needs, 30% wants, 20% savings) and how to adapt it for FIRE.',
    category: 'Saving',
    publishedAt: '2026-06-17',
    readTime: '5 min read',
    body: [
      h2('The 50/30/20 rule explained'),
      p('The 50/30/20 budget rule is a simple framework to allocate after-tax income:'),
      ul([
        '50% → needs (housing, food, transportation, utilities, insurance)',
        '30% → wants (entertainment, dining out, hobbies, subscriptions)',
        '20% → savings & debt payoff',
      ]),
      p('This rule is a starting point for normal financial health. It ensures you cover necessities, enjoy life, and save. But for FIRE, you need to adapt it.'),
      h2('Why 50/30/20 is not enough for FIRE'),
      p('A 20% savings rate (after-tax) gets you to FIRE in roughly 30–35 years. For most people, that is normal retirement age, not early retirement.'),
      p('FIRE requires 50%+ savings rate. So the question becomes: how do you get there while still enjoying life?'),
      h2('Adapting 50/30/20 for FIRE'),
      p('The answer is to reduce the "needs" percentage by optimising major costs:'),
      ul([
        'Housing: share rent, choose lower cost-of-living areas, or downsize. Move from 30% to 15–20% of income.',
        'Transportation: skip the car payment, use public transit or bike, or carpool. Move from 10% to 3–5% of income.',
        'Food: cook at home, buy in bulk, skip expensive habits. Move from 10% to 6–8% of income.',
      ]),
      p('A revised FIRE-adapted budget might look like:'),
      ul([
        '35% → optimised needs (lower housing, cheaper transport, home cooking)',
        '15% → wants (reduced entertainment, but still enjoying life)',
        '50% → savings & investing',
      ]),
      h2('Key insight: wants are the lever, not needs'),
      p('If you slash needs ruthlessly, you burn out. The real lever is wants — dining out, hobbies, subscriptions, travel.'),
      p('Instead of eliminating wants, choose which ones matter to you. Skip the $200/month subscriptions you do not use. Keep the $100/month hobby that makes you happy.'),
      h2('Progressive FIRE budget stages'),
      p('Different stages of FIRE have different budgets:'),
      ol([
        'Starting out (years 1–3): 40/25/35 — build habits, cut the worst waste',
        'Building momentum (years 3–8): 35/20/45 — optimise major costs, lock in savings',
        'Approaching FIRE (years 8+): 35/15/50 — maintain, push final savings surge',
        'In FIRE: 90%+ needs + wants, 0% savings (living off portfolio)',
      ]),
      h2('The 50/30/20 debugging checklist'),
      p('If you cannot hit your target savings rate, audit:'),
      ul([
        'Are your "needs" really needs? Housing + transport are usually the leak.',
        'Are you tracking wants? Subscriptions and small purchases compound.',
        'Is income the bottleneck? At some point, earning more is easier than cutting more.',
      ]),
      h2('Real-world example'),
      p('$80,000 after-tax income (roughly $120k gross).'),
      p('Standard 50/30/20: Needs $40k, Wants $24k, Saves $16k (20 years to FIRE).'),
      p('FIRE-adapted: Needs $28k (housing $14k, food $6k, transport $4k, other $4k), Wants $12k, Saves $40k (50% rate, 17 years to FIRE).'),
      p('By optimising housing and transport and choosing wants intentionally, you double your savings rate without severe deprivation.'),
    ],
  },
]
...
const articleMetaBySlug: Record<string, LearnArticleMeta> = {
  ...
  'how-to-find-money-to-save': {
    ...
    relatedCalculators: [
      { href: '/calculators/savings-rate', label: 'Savings Rate Calculator' },
      { href: '/?source=learn-budget', label: 'FIRE Calculator' },
    ],
  },
  'behavioral-finance-why-you-sabotage-your-fire-plan': {
    ...
    relatedCalculators: [
      { href: '/?source=learn-behavior', label: 'FIRE Calculator' },
      { href: '/dashboard', label: 'Track Progress in Dashboard' },
    ],
  },
  'emergency-fund-vs-debt-payoff-priority-framework': {
    primaryStage: 'starting-out',
    secondaryStages: ['building-momentum'],
    relatedCalculators: [
      { href: '/calculators/4-percent-rule', label: 'FIRE Calculator' },
