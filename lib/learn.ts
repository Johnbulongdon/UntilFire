...
export const learnArticles: LearnArticle[] = [
  ...
  {
    slug: 'one-fund-portfolio-simplest-investing-approach',
    title: 'The One-Fund Portfolio: Why Simpler Is Usually Better',
    description: 'Why a single total-market index fund — or a simple three-fund portfolio — beats complicated stock-picking strategies for most FIRE investors.',
    category: 'Investing',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('The case for radical simplicity'),
      p('Most investing complexity adds friction without adding returns. Research consistently shows that low-cost index funds outperform the vast majority of actively managed funds over 15-year periods. The simplest portfolio — a single total-market fund — captures this benefit with near-zero effort.'),
      p('The one-fund portfolio is not a beginner shortcut. It is a deliberate choice that removes the decisions that cause most investors to underperform: market timing, sector rotation, fund-switching, and behavioural errors during downturns.'),
      h2('What a one-fund portfolio looks like'),
      p('At its simplest, a one-fund portfolio is a single total US market index fund held in every account you own. Common options:'),
      ul([
        'VTSAX (Vanguard Total Stock Market Index Fund Admiral) — minimum $3,000',
        'VTI (Vanguard Total Stock Market ETF) — same index, no minimum, tradeable intraday',
        'FZROX (Fidelity Zero Total Market Index Fund) — zero expense ratio, Fidelity only',
        'SWTSX (Schwab Total Stock Market Index Fund) — low cost, no minimum',
      ]),
      p('Each of these funds holds 3,500–4,000 US companies weighted by market cap. You own a tiny slice of every significant business in the US economy. When the economy grows, you grow.'),
      h2('The three-fund portfolio: one step up in complexity'),
      p('The classic three-fund portfolio adds international stocks and bonds to the mix. It is the most widely recommended approach for FIRE investors who want a small amount of additional diversification:'),
      ul([
        'Total US market index fund — 60–70% of portfolio',
        'Total international market index fund — 20–30% of portfolio',
        'Total bond market index fund — 10–20%, adjusted toward lower percentages for younger investors',
      ]),
      p('The international allocation catches growth outside the US. The bond allocation reduces volatility, particularly important in the years approaching and just after retirement when sequence risk is highest.'),
      h2('Why the three-fund portfolio beats most alternatives'),
      p('A 2023 SPIVA report found that over 15 years, 92% of US large-cap actively managed funds underperformed the S&P 500. Over 20 years, the number climbs above 94%. The drag is mainly fees: actively managed funds typically charge 0.5–1.5% per year versus 0.03–0.05% for total-market index funds.'),
      p('On a $500,000 portfolio, the difference between 1% and 0.04% in annual fees is roughly $4,800 per year — money that compounds against you in an active fund but for you in an index fund.'),
      h2('When to deviate from one or three funds'),
      p('A few cases where adding complexity is justified:'),
      ul([
        'Small-cap tilt — if you want to overweight small and mid-cap stocks, adding a dedicated small-cap fund (VB, VIOV) is evidence-backed, though it adds tracking error.',
        'Factor investing — value and profitability tilts have long-run evidence, but underperform for stretches that test discipline.',
        'Tax-loss harvesting — some investors hold similar but not identical funds to harvest losses while maintaining exposure.',
      ]),
      p('For most FIRE investors, the additional returns from these tweaks are small and speculative. The discipline to stay invested through downturns matters far more than allocation fine-tuning.'),
      h2('The portfolio is not the strategy — the strategy is staying invested'),
      p('The primary advantage of a simple portfolio is that it is easy to hold for 20 years. When markets fall 30%, a one-fund investor has nothing to rebalance across, nothing to second-guess, and no performance comparisons to distract them. They hold. That behavioural advantage often outweighs any allocation benefit from a more complex portfolio.'),
    ],
  },
  {
    slug: 'tax-diversification-three-bucket-strategy',
    title: 'Tax Diversification: Why You Need All Three Account Types',
    description: 'How holding taxable, tax-deferred, and Roth accounts gives you maximum flexibility to manage taxes in retirement — and how to build this mix on the path to FIRE.',
    category: 'Tax Strategy',
    publishedAt: '2026-06-18',
    readTime: '7 min read',
    body: [
      h2('What is tax diversification?'),
      p('Tax diversification means holding investments across three different account types: taxable brokerage accounts, tax-deferred accounts (traditional 401k, traditional IRA), and tax-free accounts (Roth 401k, Roth IRA). Each account type is taxed differently, and having all three gives you the ability to draw income from the most tax-efficient source in any given retirement year.'),
      p('Most people understand asset diversification — holding different investments to reduce risk. Tax diversification is the parallel idea applied to tax treatment: by spreading across all three buckets, you reduce your exposure to any single tax outcome in retirement.'),
      h2('The three buckets'),
      h3('Bucket 1: Taxable brokerage accounts'),
      p('Money in a regular brokerage account is invested after tax. Gains are taxed at capital gains rates (0%, 15%, or 20% federally depending on income). Qualified dividends are taxed the same way. There are no contribution limits, no withdrawal restrictions, and no required minimum distributions. Taxable accounts are the most flexible.'),
      h3('Bucket 2: Tax-deferred accounts (traditional 401k / IRA)'),
      p('Contributions reduce taxable income today. The money grows tax-free inside the account. Withdrawals in retirement are taxed as ordinary income. Required minimum distributions (RMDs) start at age 73. For FIRE investors, the key drawback is that large balances in tax-deferred accounts force high income in later life, potentially pushing you into higher brackets.'),
      h3('Bucket 3: Tax-free accounts (Roth 401k / Roth IRA)'),
      p('Contributions are made after tax. Growth and qualified withdrawals are completely tax-free. No RMDs. Roth IRAs can be accessed penalty-free after 5 years using the Roth conversion ladder. For early retirees, Roth accounts are often the most valuable bucket over the long run.'),
      h2('Why all three buckets matter in early retirement'),
      p('In a single-bucket retirement, you have no flexibility. Consider a retiree with only traditional IRA money: every dollar they withdraw is ordinary income. If they need $80,000 in a year, all $80,000 hits ordinary income rates — potentially pushing them into the 22% or 24% bracket.'),
      p('With all three buckets, that same retiree can engineer a low-tax year: withdraw $25,000 from traditional IRA (staying in the 12% bracket), $30,000 from Roth (tax-free), and $25,000 from selling appreciated positions in a taxable account at 0% long-term capital gains rates (available up to about $94,000 for married couples in 2024). Total tax rate: effectively under 5% on $80,000 of spending.'),
      h2('How to build tax diversification on the FIRE path'),
      p('Most employers only offer traditional or Roth 401k options, not both. Building all three buckets requires deliberate action:'),
      ul([
        'Contribute enough to your 401k to capture any employer match — always worth it regardless of traditional vs Roth.',
        'Open a Roth IRA (income limits apply — use backdoor Roth if above threshold).',
        'Open a taxable brokerage account and invest anything beyond the tax-advantaged limits.',
        'If your employer offers a Roth 401k option and you are in a low current bracket, choose Roth over traditional.',
        'In high-income years, lean traditional (bigger deduction now). In low-income years, lean Roth (lower rate to pay now).',
      ]),
      h2('The Roth conversion strategy'),
      p('Early retirees often have a window of low-income years before Social Security and RMDs kick in. This is the ideal time to convert traditional IRA money to Roth: you pay tax now at a low rate and create tax-free money for later. Partial conversions — keeping income below the top of the 12% bracket — can shift hundreds of thousands of dollars to tax-free status over a decade.'),
      p('Tax diversification is not about minimising the tax you pay today. It is about controlling what tax bracket you live in each year of retirement, which over a 30-year horizon makes a material difference to how long your portfolio lasts.'),
    ],
  },
  {
    slug: 'kids-and-fire-financial-independence-with-children',
    title: 'Kids and FIRE: Pursuing Financial Independence With Children',
    description: 'How to navigate the FIRE path with children — the real cost impact, 529 accounts, UGMA accounts, and how families reach financial independence without sacrificing education funding.',
    category: 'Planning',
    publishedAt: '2026-06-18',
    readTime: '8 min read',
    body: [
      h2('Children change the FIRE math — but do not break it'),
      p('Children add significant cost to the FIRE equation: childcare, healthcare, food, activities, and eventual education expenses. But they do not make FIRE impossible. Families with children consistently reach financial independence, often by adjusting timelines by a few years rather than decades. The key is honest accounting of actual child-related costs and building education funding alongside portfolio growth.'),
      h2('The actual cost of raising a child'),
      p('The USDA estimates the average US family spends about $16,000–$18,000 per year raising a child, depending on household income and location. This figure covers housing, food, childcare, clothing, healthcare, and entertainment but excludes college. The number is lower for families who already own their home (marginal housing cost is small) and higher in expensive cities with premium childcare.'),
      p('Childcare is often the most significant early cost: full-time daycare runs $12,000–$25,000 per year in major cities. This cost typically drops sharply when children enter kindergarten, then shifts to activities and extracurricular costs during the school years.'),
      h2('Adjusting your FIRE number for children'),
      p('The standard approach is to include child-related expenses in your retirement spending estimate for however long children will be financially dependent — typically until 18–22. This means your annual retirement spending is higher during those years, which may require a larger initial portfolio or a willingness to run flexible withdrawals.'),
      p('Some FIRE parents separate education funding entirely: they build a college fund alongside their regular portfolio rather than relying on the retirement portfolio for tuition. This keeps the retirement math cleaner and avoids the risk of college expenses disrupting withdrawal strategy.'),
      h2('529 plans: tax-free education savings'),
      p('A 529 plan is a state-sponsored savings account where contributions grow tax-free and withdrawals are tax-free when used for qualified education expenses (tuition, fees, room and board, books). Key features:'),
      ul([
        'No annual contribution limit per account, though contributions reduce the gift tax exclusion ($18,000 per person per year in 2024).',
        'Superfunding: you can contribute 5 years of gift tax exclusions in one lump sum ($90,000 per child) without gift tax consequences.',
        'Investment options: typically a range of index funds similar to a 401k menu. Choose low-cost index options.',
        'Beneficiary flexibility: unused funds can be transferred to another family member, including yourself, or rolled over to a Roth IRA (up to $35,000 lifetime, after 15-year account age).',
        'State tax deductions: many states allow deductions on contributions to that state\'s 529 plan.',
      ]),
      p('The Roth IRA rollover option added in 2024 makes overfunding a 529 less risky — excess education savings can eventually become retirement savings.'),
      h2('UGMA/UTMA accounts: investing for children'),
      p('Uniform Gifts to Minors Act (UGMA) and Uniform Transfers to Minors Act (UTMA) accounts are taxable custodial accounts that transfer to the child\'s control at age 18 or 21 (varies by state). They are more flexible than 529s — funds can be used for anything, not just education. The downside: investment gains are taxable, and the account is counted as the child\'s asset for financial aid calculations (which hurts aid eligibility more than a parent-owned 529).'),
      p('For FIRE families with children who may not attend traditional college, UGMA/UTMA accounts are worth considering as a supplement to 529 plans — they give the child capital to start adulthood.'),
      h2('Dual-income FIRE families: using the childcare years strategically'),
      p('The years with the highest childcare costs ($0–5 age range) are also typically high-income years for dual-income couples. This creates a natural tension: childcare costs reduce investable savings, but incomes are rising. Strategies to navigate this window:'),
      ul([
        'Use Dependent Care FSAs to pay up to $5,000 in childcare with pre-tax dollars, saving 22–32% on that amount.',
        'Maximize employer 401k contributions during high-income years, especially if both spouses have access to 401k matching.',
        'Consider delaying major lifestyle upgrades (car, house size) during the childcare years — the temporary cost pressure passes.',
        'Model a stepped timeline: FIRE number grows with children present, then drops after they become financially independent.',
      ]),
      h2('The timeline adjustment'),
      p('Most honest FIRE-with-kids analyses show a timeline extension of 2–5 years compared to a childless scenario with similar income and expenses. That is not a failure — that is the cost of raising children, priced in years rather than dollars. Families who reach FIRE with children do it by treating the timeline as flexible rather than fixed: if year 12 is not ready, year 14 might be, and the path is clear either way.'),
    ],
  },
]
...
const articleMetaBySlug: Record<string, LearnArticleMeta> = {
  ...
  'one-fund-portfolio-simplest-investing-approach': {
    primaryStage: 'starting-out',
    secondaryStages: ['building-momentum'],
    relatedCalculators: [
      { href: '/calculators/compound-interest', label: 'Compound Interest Calculator' },
      { href: '/?source=learn-one-fund', label: 'FIRE Calculator' },
    ],
  },
  'tax-diversification-three-bucket-strategy': {
    primaryStage: 'approaching-fire',
  ...
  'kids-and-fire-financial-independence-with-children': {
    primaryStage: 'building-momentum',
    secondaryStages: ['starting-out', 'approaching-fire'],
    relatedCalculators: [
      { href: '/calculators/savings-rate', label: 'Savings Rate Calculator' },
      { href: '/?source=learn-kids-fire', label: 'FIRE Calculator' },
    ],
  },
}
