...
export const learnArticles: LearnArticle[] = [
  ...
  {
    slug: 'emergency-fund-size-and-strategy-for-fire',
    title: 'Emergency Fund Size and Strategy on the Path to FIRE',
    description: 'How to size your emergency fund, where to keep it, and how its role shifts once you reach financial independence.',
    category: 'Planning',
    publishedAt: '2026-06-18',
    readTime: '5 min read',
    body: [
      h2('What an emergency fund actually does'),
      p('An emergency fund is a cash buffer that prevents unexpected expenses — a job loss, car repair, medical bill, or broken appliance — from forcing you to sell investments at the wrong time. Without one, a $3,000 emergency during a market downturn might mean selling index fund shares at a 20% loss to cover it. With one, you pay from cash and let the portfolio recover undisturbed.'),
      p('The emergency fund is not an investment. Its job is to protect the investment portfolio from being disrupted by life.'),
      h2('How much do you need?'),
      p('The standard advice is 3–6 months of essential expenses. For FIRE planners, the more useful framework is:'),
      ul([
        'Stable job, low debt, renting: 3 months is usually sufficient. Your main risk is a gap between jobs, and 3 months covers most hiring timelines.',
        'Variable income, freelance, or self-employed: 6–9 months. Irregular income means you may need to bridge longer gaps without touching investments.',
        'One-income household with dependents: 6 months minimum. A single job loss eliminates all income.',
        'Nearing or at FIRE: 1–2 years in cash or short-term bonds. This acts as a "cash buffer" that insulates the portfolio from selling during early-retirement market downturns.',
      ]),
      p('Essential expenses, not total spending: the fund should cover rent/mortgage, food, utilities, insurance, and minimum debt payments — not dining out or vacations.'),
      h2('Where to keep an emergency fund'),
      p('The goal is immediate access and no loss of principal. Not the stock market — emergency funds cannot be down 20% when you need them.'),
      ul([
        'High-yield savings account (HYSA): earns 4–5% interest (in current rate environments), FDIC insured, accessible in 1–2 business days. The default choice for most people.',
        'Money market account: similar yield to HYSA, sometimes with check-writing access. Good for larger emergency funds.',
        'Treasury bills (4-week or 3-month): slightly higher yield than HYSA, very low risk, but takes a few days to access. Good for the portion you are less likely to need quickly.',
        'I bonds: inflation-protected, but cannot be redeemed for 12 months and yield can vary. Not ideal for true emergency access.',
      ]),
      p('Do not use a regular checking account — the lost interest on $20,000 at 0.01% vs 4.5% is nearly $900 per year.'),
      h2('The FIRE-specific twist: cash buffer vs emergency fund'),
      p('Once you are in or near retirement, the emergency fund concept expands into a "cash buffer" — typically 1–3 years of spending in cash or short-term bonds held outside the investment portfolio.'),
      p('The purpose is different from a working-years emergency fund. It is not for unexpected expenses (though it handles those too). Its primary function is to prevent sequence-of-returns risk: if the market drops 30% in year 2 of retirement, you draw from the cash buffer instead of selling depressed equities. This gives the portfolio time to recover.'),
      ul([
        '1-year buffer: minimum for early retirees. Covers one down year without portfolio sales.',
        '2-year buffer: most FIRE practitioners use this. Covers a prolonged bear market like 2000–2002.',
        '3-year buffer: maximum useful range. Beyond 3 years, the opportunity cost of holding cash exceeds the protection benefit.',
      ]),
      h2('When to build the emergency fund'),
      p('Before investing. Not instead of investing — before. The sequence that maximises expected wealth:'),
      ol([
        'Build a starter emergency fund of $1,000–$2,000 immediately.',
        'Contribute to employer 401(k) up to the full match.',
        'Build the full emergency fund (3–6 months).',
        'Max tax-advantaged accounts (Roth IRA, full 401k).',
        'Invest in taxable brokerage accounts.',
      ]),
      p('Many FIRE planners skip step 3 in the rush to invest. The cost is invisible — until an emergency forces you to sell during a downturn.'),
    ],
  },
  {
    slug: 'geographic-arbitrage-cut-your-fire-timeline',
    title: 'Geographic Arbitrage: How Moving Can Accelerate Your FIRE Timeline',
    description: 'How relocating to a lower cost-of-living city or country can dramatically increase your savings rate, shrink your FIRE number, and move your freedom date years closer.',
    category: 'FIRE Basics',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('What is geographic arbitrage?'),
      p('Geographic arbitrage is earning income at a high-cost-of-living rate while spending at a low-cost-of-living rate. The simplest version: you earn a San Francisco software engineer salary but live in rural Portugal. The result is a savings rate that would be nearly impossible in a high-cost city.'),
      p('It works because income in many professions is not tightly coupled to local cost of living. Remote work, freelancing, and online business have made geographic arbitrage accessible to a much larger share of workers than ever before.'),
      h2('The math: why it compounds so powerfully'),
      p('Geographic arbitrage has a double effect on your FIRE timeline — it simultaneously increases your savings rate and decreases your FIRE number.'),
      p('Example: a single person earning $120,000 in San Francisco, spending $80,000, saving $40,000 per year. FIRE number at $80,000 spending: $2,000,000. Timeline: roughly 22 years.'),
      p('Same person moves to a mid-tier US city (Phoenix, Raleigh, Denver suburb) and drops spending to $45,000. Savings: $75,000/year. FIRE number at $45,000 spending: $1,125,000. Timeline: roughly 10–12 years.'),
      p('A single geographic move cut the timeline almost in half — not from a salary change, but from a spending change that also shrank the target.'),
      h2('Domestic geographic arbitrage'),
      p('Within the US, the cost-of-living spread between the highest and lowest cities is extreme:'),
      ul([
        'San Francisco, NYC, Seattle: median rent $3,000–$4,000+/month for a one-bedroom',
        'Austin, Denver, Chicago: $1,500–$2,200/month',
        'Raleigh, Phoenix, Tampa, Nashville: $1,200–$1,800/month',
        'Midwest cities (Columbus, Kansas City, Omaha): $900–$1,400/month',
      ]),
      p('For remote workers, the income stays the same. The rent difference alone — say $2,500/month — is $30,000 per year that converts directly into savings. At a 7% investment return, that extra $30,000 per year is worth roughly $750,000 over 15 years.'),
      h2('International geographic arbitrage'),
      p('For people willing to live abroad, the leverage is even greater. Countries popular with FIRE expats:'),
      ul([
        'Portugal (Lisbon, Porto): $2,500–$3,500/month all-in for a comfortable lifestyle. EU-quality healthcare, safety, and infrastructure.',
        'Mexico (Mexico City, Mérida, Oaxaca): $1,500–$2,500/month. Close to the US, reasonable healthcare, large expat communities.',
        'Thailand (Chiang Mai, Bangkok): $1,200–$2,000/month. Southeast Asian baseline, high quality of life at low cost.',
        'Colombia (Medellín, Bogotá): $1,500–$2,500/month. Fast-growing expat scene, modern infrastructure.',
        'Eastern Europe (Krakow, Tallinn, Tbilisi): $1,500–$2,500/month. European culture, lower costs.',
      ]),
      p('A household that retires to Portugal on $40,000/year in spending needs a $1,000,000 portfolio at 4%. The same household living in San Francisco needs $80,000/year, which requires $2,000,000.'),
      h2('The FIRE number shrinks permanently'),
      p('This is the core insight of geographic arbitrage: it is not just about saving more while working. Retiring somewhere cheaper also reduces the portfolio you need. If you plan to retire abroad at $30,000/year, your FIRE number is $750,000 — a target achievable 10–15 years earlier than a $2,000,000 target.'),
      h2('What to watch for'),
      ul([
        'Visa and residency rules: most countries require planning. Portugal\'s D7 passive income visa, Mexico\'s temporary residency, and Thailand\'s retirement visa all have specific income or asset requirements.',
        'Currency risk: if you hold USD investments and spend in euros or baht, currency fluctuations affect your purchasing power. Modest exposure is manageable; catastrophic devaluation in either direction is rare.',
        'Healthcare access: international healthcare is often excellent and cheap, but research quality before choosing a country. Private health insurance for expats typically costs $100–$300/month.',
        'Social and family ties: the biggest non-financial variable. Living 5,000 miles from family has real costs — flights, missed events, time zone barriers — that affect quality of life.',
      ]),
      h2('The minimum viable version'),
      p('You do not need to move to Southeast Asia to benefit from geographic arbitrage. Even moving within the US from an expensive coastal city to a mid-cost inland city can add $20,000–$40,000 per year to your savings rate with no income change. That single decision, made once, can shorten your FIRE timeline by 5–8 years.'),
    ],
  },
  {
    slug: 'psychology-of-spending-less-sustainable-frugality',
    title: 'The Psychology of Spending Less: How to Make Frugality Last',
    description: 'Why willpower-based frugality fails, and what behavioral strategies actually work for sustaining a high savings rate over years without misery.',
    category: 'FIRE Basics',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('Why willpower frugality fails'),
      p('Most people who try to "spend less" approach it as pure self-denial: cut everything that feels like a luxury, track every dollar with anxiety, and white-knuckle through temptation. This approach usually fails within a few months. It fails not because people lack discipline, but because it ignores how human psychology actually works.'),
      p('Long-term behavior change does not come from willpower. It comes from designing an environment where the desired behavior is easy and the undesired behavior is hard. The same principle applies to spending.'),
      h2('The hedonic treadmill: why more spending does not make you happier'),
      p('Hedonic adaptation is the psychological process by which we return to a baseline happiness level after positive events — including spending upgrades. You buy a nicer car, feel happy for a few weeks, then return to baseline. The new car becomes normal. You no longer notice it.'),
      p('This means lifestyle inflation does not persistently increase happiness — it raises the baseline and requires ever more spending just to maintain the same feeling. The FIRE insight: spending less does not mean being less happy. It means stopping the treadmill.'),
      p('Research consistently shows that beyond a moderate income (roughly $75,000–$100,000 household, depending on cost of living), additional income adds very little to day-to-day wellbeing. The top performers on happiness measures — time freedom, close relationships, meaningful work, physical health — are all available at low financial cost.'),
      h2('The high-impact vs low-impact spend distinction'),
      p('Not all spending is equal in terms of the happiness it generates. Research by behavioral economists Elizabeth Dunn and Michael Norton identifies spending patterns that generate lasting happiness:'),
      ul([
        'Experiences over things: a trip to a national park generates longer-lasting positive memory than a TV upgrade of equal cost.',
        'Time-buying: paying for services that free up your time (cleaning, food delivery when genuinely time-constrained) has a higher happiness-per-dollar than buying objects.',
        'Social spending: spending on others or shared experiences (a dinner with close friends) generates more sustained happiness than solo consumption.',
        'Anticipation value: cheap experiences with high anticipation (a camping trip planned months ahead) generate more total happiness than expensive impulse purchases.',
      ]),
      p('FIRE-compatible frugality means cutting spending that generates low happiness (subscriptions you forget, status goods, frequent dining out by default) while protecting spending that genuinely matters (travel, social experiences, health).'),
      h2('Automating the savings rate'),
      p('The most powerful behavior change technique for high savings rates is removing the decision entirely. Automate a transfer from your checking account to your investment account on payday — before you can spend it. This is "paying yourself first."'),
      p('The psychological mechanism: money you never see in your checking account does not feel like money you are denying yourself. Your lifestyle adapts to what remains. Most people find that after 2–3 months, they have adjusted to the lower available balance and no longer miss the automated savings.'),
      p('Raising the automated savings rate by 1% every six months — often in tandem with a raise — is one of the most effective ways to reach a 40–50% savings rate without ever experiencing a dramatic lifestyle cut.'),
      h2('Identity-based frugality'),
      p('Habits that are attached to identity last longer than habits attached to external outcomes. "I am someone who does not carry consumer debt" outlasts "I want to pay off my card by March." "I am a person who cooks at home" outlasts "I want to save $400 on food this month."'),
      p('Reframing the FIRE path as a core part of your identity — not a temporary sacrifice — makes the behavioral patterns more durable. Many successful FIRE practitioners describe their relationship with money as fundamentally shifting: from spending as a source of pleasure to building freedom as the primary goal.'),
      h2('What actually drives overspending'),
      p('Most overspending has a root cause that is not really about money:'),
      ul([
        'Social comparison: spending to keep up with peers, neighbours, or social media. Addressed by curating your social environment.',
        'Emotional regulation: spending as a response to stress, boredom, or anxiety. Addressed by identifying the trigger and finding a non-spending alternative.',
        'Convenience defaults: subscriptions, auto-renews, and default spending that happens without conscious decision. Addressed by periodic audits.',
        'Identity spending: buying things that signal status or self-worth. Addressed by building identity around non-consumable values.',
      ]),
      p('Understanding your specific pattern makes targeted changes far more effective than generic "spend less" advice.'),
      h2('The sustainability test'),
      p('A frugality approach is sustainable if you can imagine doing it indefinitely without resentment. If your current spending plan makes you anxious, deprived, or bitter about money, it will not last 15 years. The goal is to find the version of lower spending that still feels like a good life — just a more intentional one.'),
    ],
  },
]
...
const articleMetaBySlug: Record<string, LearnArticleMeta> = {
  ...
  'emergency-fund-size-and-strategy-for-fire': {
    primaryStage: 'starting-out',
  ...
  'geographic-arbitrage-cut-your-fire-timeline': {
    primaryStage: 'building-momentum',
    secondaryStages: ['starting-out', 'approaching-fire'],
    relatedCalculators: [
      { href: '/?source=learn-geo-arbitrage', label: 'FIRE Calculator' },
      { href: '/calculators/savings-rate', label: 'Savings Rate Calculator' },
    ],
  },
  'psychology-of-spending-less-sustainable-frugality': {
    primaryStage: 'starting-out',
    secondaryStages: ['building-momentum'],
    relatedCalculators: [
      { href: '/calculators/savings-rate', label: 'Savings Rate Calculator' },
