...
export const learnArticles: LearnArticle[] = [
  ...
  {
    slug: 'social-security-optimization-early-retirees',
    title: 'Social Security Optimization for Early Retirees: When to Claim and Why It Matters',
    description: 'How early retirement affects Social Security benefits, the break-even analysis for claiming at 62 vs 67 vs 70, spousal strategies, and how to factor Social Security into FIRE planning.',
    category: 'Tax Strategy',
    publishedAt: '2026-06-18',
    readTime: '7 min read',
    body: [
      h2('How Social Security works for FIRE retirees'),
      p('Social Security benefits are calculated based on your 35 highest-earning years. If you retire at 40 with 20 years of earnings history, the Social Security Administration fills the remaining 15 years with zeros — significantly reducing your benefit compared to someone who worked 35 full years. Early retirement has a real cost to Social Security, and it should be factored into FIRE planning honestly.'),
      p('The good news: even with reduced benefits, Social Security remains a valuable asset for most FIRE retirees. Benefits received for life provide longevity insurance that no portfolio can perfectly replicate. The question is not whether to claim — it is when.'),
      h2('Claiming ages and benefit amounts'),
      p('You can claim Social Security as early as age 62 or as late as age 70. Your Full Retirement Age (FRA) is 67 for people born after 1960. The benefit adjustments work as follows:'),
      ul([
        'Claim at 62: receive approximately 70% of your FRA benefit (a 30% permanent reduction).',
        'Claim at FRA (67): receive 100% of your calculated benefit.',
        'Claim at 70: receive approximately 124% of your FRA benefit (delayed credits of 8% per year from 67 to 70).',
      ]),
      p('These are permanent adjustments — not temporary. Claiming at 62 means receiving 70% of the FRA benefit for life. Claiming at 70 means receiving 124% for life.'),
      h2('The break-even analysis'),
      p('The break-even point is the age at which delaying becomes financially superior. If your FRA benefit is $2,000/month:'),
      ul([
        'Claiming at 62 vs 67: you receive $1,400/month for 5 extra years ($84,000 more) by claiming early. At 67, the $600/month difference means it takes roughly 140 months (about 11.7 years) to break even — age 78.7. If you expect to live past 79, delaying to FRA likely produces more lifetime income.',
        'Claiming at 67 vs 70: the FRA vs age 70 break-even is roughly age 82–83.',
      ]),
      p('For FIRE retirees with long life expectancy (which correlates with higher income, better healthcare access, and healthier lifestyle), delaying to 70 is often the optimal strategy — particularly for the higher earner in a married couple.'),
      h2('The Social Security bridge strategy'),
      p('Early FIRE retirees often use a Social Security bridge strategy: spend down taxable accounts and do Roth conversions during the low-income years between retirement and age 70, then let Social Security provide the income floor from 70 onward. This strategy:'),
      ul([
        'Maximises the tax-free Roth conversion window before Social Security income pushes them into higher brackets.',
        'Allows the portfolio to grow for additional years before drawing from it for living expenses.',
        'Provides the largest possible inflation-adjusted lifetime income guarantee from Social Security.',
      ]),
      h2('Spousal benefits'),
      p('A spouse who did not work (or had low earnings) can claim up to 50% of the higher earner\'s FRA benefit. This does not reduce the higher earner\'s benefit. Spousal benefits can be claimed as early as 62 (reduced) or at the spouse\'s own FRA (full 50%).'),
      p('For married FIRE couples, coordinating Social Security claims can significantly increase lifetime household income. A common strategy: the lower earner claims early (providing income during the gap years) while the higher earner delays to 70 for the maximum benefit, which also becomes the survivor benefit if the higher earner dies first.'),
      h2('The Social Security earnings test'),
      p('If you claim Social Security before FRA and continue working, benefits are temporarily reduced if earnings exceed $22,320 (2024). For every $2 earned above the threshold, $1 in benefits is withheld. This reduction is not permanent — withheld benefits are recalculated at FRA and added back as a higher monthly payment. But for FIRE retirees earning side income, it is worth understanding.'),
    ],
  },
  {
    slug: 'retirement-spending-smile-flexible-spending',
    title: 'The Retirement Spending Smile: Why Real Spending Is Not Flat',
    description: 'How actual retirement spending patterns differ from flat inflation-adjusted assumptions — the spending smile curve, what drives it, and how flexible spending improves portfolio survival rates.',
    category: 'Withdrawal Strategy',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('The problem with flat spending assumptions'),
      p('Standard FIRE calculations assume inflation-adjusted spending remains constant throughout retirement. You spend $60,000 in year one, $62,400 in year two (at 4% inflation), and so on indefinitely. This is a useful simplification for projections, but it does not reflect how people actually spend money in retirement.'),
      p('Research on actual retiree spending patterns — most extensively documented by Ty Bernicke and David Blanchett — consistently shows a different shape: spending is high in early retirement, declines in middle retirement, then may rise again in very late retirement driven by healthcare costs. This pattern is called the retirement spending smile.'),
      h2('The three phases of retirement spending'),
      h3('Phase 1: The Go-Go years (early retirement, roughly 60–75)'),
      p('Early retirement spending is typically higher than average. New retirees travel extensively, pursue hobbies and activities they deferred during working years, and spend on experiences while health and energy are high. This phase justifies planning for higher spending in early retirement rather than assuming everything is flat from day one.'),
      h3('Phase 2: The Slow-Go years (mid-retirement, roughly 75–85)'),
      p('Spending naturally declines in mid-retirement. Travel becomes less frequent. Restaurants and activities are replaced by home-based hobbies. Major purchases (cars, appliances) are less common. Research shows that real spending declines 1–2% per year during this phase for the average retiree, producing spending patterns significantly below the flat-spending assumption.'),
      h3('Phase 3: The No-Go years (late retirement, roughly 85+)'),
      p('Spending may rise again in late retirement due to healthcare and long-term care costs. This is the most unpredictable phase — healthcare costs are highly variable, and long-term care costs (home health aides, assisted living, nursing home) can be very large. Some retirees have minimal late-life healthcare costs; others face $100,000+ per year in care costs.'),
      h2('What the spending smile means for FIRE planning'),
      p('Blanchett\'s research showed that retirees who planned for a flat spending assumption typically overfunded their retirement by 10–20%. The spending smile suggests you can safely spend more in early retirement (travel, experiences) knowing that middle-retirement spending will naturally decline — improving the enjoyment of the early years without meaningfully increasing portfolio depletion risk.'),
      p('It also suggests planning specifically for late-life healthcare costs rather than folding them into a flat assumption. An HSA, long-term care insurance, or a dedicated healthcare reserve handles this tail risk more precisely than a blanket spending increase throughout retirement.'),
      h2('Flexible spending: the practical implication'),
      p('The spending smile is one argument for flexible (rather than fixed) withdrawal strategies. If you know spending will naturally decline in mid-retirement, you can accept a variable withdrawal rate rather than rigidly protecting against worst-case flat-spending scenarios. Dynamic withdrawal strategies — like guardrails — accommodate this natural variation more elegantly than fixed 4% withdrawals do.'),
      p('The practical upshot: do not defer all experiences to "when I have enough." Early retirement is when you have the energy and health to enjoy them most. Plan for higher early spending, build in the middle-retirement plateau, and address late-life healthcare separately.'),
    ],
  },
  {
    slug: 'fire-identity-purpose-after-career',
    title: 'FIRE and Identity: Who Are You When Work Is No Longer the Answer?',
    description: 'The psychological transition from career identity to post-FIRE life — how to build purpose, structure, and community after leaving work, and why this matters as much as the financial plan.',
    category: 'Psychology',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('The question that outlasts the financial plan'),
      p('Most FIRE planning focuses on the financial transition: savings rate, portfolio size, withdrawal strategy, tax optimization. These are necessary and well-covered. The question that receives far less attention is the human one: what do you do with the freedom you have spent years creating?'),
      p('The FIRE community\'s conversation about post-retirement life is sparse compared to its attention to accumulation. But the evidence is clear that purpose, structure, social connection, and a sense of identity are as important to wellbeing in early retirement as financial security. Building them deliberately, before and during the transition, is as important as building the portfolio.'),
      h2('Career provides more than income'),
      p('Work provides income, but it also provides:'),
      ul([
        'Structure: a schedule that organises the day and week.',
        'Social connection: colleagues, professional networks, shared purpose.',
        'Identity: a clear answer to "what do you do?"',
        'Intellectual stimulation: problems to solve, skills to develop.',
        'Status: recognition, advancement, and a sense of progress.',
        'Purpose: contributing to something larger than yourself.',
      ]),
      p('When work ends, all of these go with it simultaneously. The financial plan addresses income. Nothing automatically replaces the rest. Early retirees who plan only for the financial transition often find themselves unexpectedly adrift in the first year — regardless of portfolio size.'),
      h2('Building a post-FIRE structure'),
      p('The most reported challenge in early retirement is unstructured time. The solution is not to create a rigid schedule that mimics work — it is to design a structure that comes from genuine interest rather than external obligation.'),
      ul([
        'Anchor activities: 2–3 activities that occur on a regular schedule and give the week shape. A weekly volunteer shift, a standing tennis game, a creative project with a regular work session.',
        'A project with a horizon: something you are building or working toward over months. A book, a garden, a community initiative, a skill. Projects provide the forward motion that careers provided naturally.',
        'Community: regular contact with people who share interests. Not just social media — physical communities with recurring contact, shared purpose, and the kind of genuine relationship that develops over years.',
      ]),
      h2('The identity transition'),
      p('"What do you do?" is a harder question to answer in post-FIRE life than most FIRE planning acknowledges. The honest answer — "I retired early" — invites skepticism from many people, and can feel incomplete to high-achievers who built identity around career accomplishment.'),
      p('The reframe: financial independence creates the freedom to answer "what do I do?" with something genuine rather than something you stumbled into or something you do primarily for money. Many FIRE retirees find this reframe liberating once they make peace with the transition period. The question is not "how do I explain early retirement?" — it is "what do I actually want to spend my time on when cost is not the primary constraint?"'),
      h2('The partial FIRE path: FI without full RE'),
      p('Many people who reach financial independence choose not to fully retire. They leave careers that exhausted them and move to work that is meaningful, lower-stress, and lower-paid — often described as Barista FIRE or semi-retirement. Financial independence made the career change possible; it did not require stopping work entirely.'),
      p('This path often produces better life outcomes than either grinding through until traditional retirement or cold-turkey retiring at 40. Work chosen freely, at a pace and type that suits you, provides the structure and purpose benefits of a career without its constraints. The financial plan supports this flexibility; it does not mandate any particular relationship with work.'),
    ],
  },
]
...
const articleMetaBySlug: Record<string, LearnArticleMeta> = {
  ...
  'social-security-optimization-early-retirees': {
    primaryStage: 'living-in-fire',
    secondaryStages: ['approaching-fire'],
    relatedCalculators: [
      { href: '/calculators/4-percent-rule', label: 'Safe Withdrawal Calculator' },
  ...
  'retirement-spending-smile-flexible-spending': {
    primaryStage: 'living-in-fire',
    secondaryStages: ['approaching-fire'],
    relatedCalculators: [
      { href: '/calculators/4-percent-rule', label: 'Safe Withdrawal Calculator' },
  ...
  'fire-identity-purpose-after-career': {
    primaryStage: 'living-in-fire',
    secondaryStages: ['approaching-fire'],
    relatedCalculators: [
      { href: '/?source=learn-fire-identity', label: 'FIRE Calculator' },
      { href: '/dashboard', label: 'Dashboard' },
    ],
  },
}
