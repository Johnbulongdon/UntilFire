...
export const learnArticles: LearnArticle[] = [
  ...
  },
  {
    ...
    description: 'The evidence on whether to invest a windfall all at once or spread it out — and why the answer differs between theory and what works in practice.',
    category: 'Investing',
    publishedAt: '2026-06-18',
    readTime: '5 min read',
    body: [
      h2('The question everyone faces with a windfall'),
      p('You receive $50,000 from a bonus, inheritance, or sale. Do you invest it all today, or spread it over 6–12 months? This is the dollar-cost averaging (DCA) versus lump sum debate — and both camps have reasonable arguments.'),
      h2('What the research says: lump sum wins on average'),
      p('A widely cited Vanguard study found that lump sum investing outperforms dollar-cost averaging approximately two-thirds of the time across US, UK, and Australian markets. The reason is straightforward: markets trend upward over time. Every month you hold cash instead of investing, you are likely leaving market return on the table.'),
      p('The longer the DCA period, the worse the average outcome. Spreading $50,000 over 12 months means the last installment went into the market 11 months later than it could have. In a year with 10% returns, that cash drag cost roughly $4,500 in foregone growth.'),
      h2('Why DCA still makes sense for many people'),
      p('The research conclusion — "lump sum wins" — comes with critical caveats that change the practical answer for most people:'),
      ul([
        'Psychological risk: if you invest the lump sum and the market immediately drops 20%, many people panic-sell. DCA reduces the chance of a catastrophically timed single entry point. The investor who sticks to DCA through volatility will outperform the lump-sum investor who sells after a crash.',
        'Regret risk: buying everything at the top and watching it decline for 18 months is emotionally brutal. DCA smooths this experience even if the average outcome is slightly worse.',
        'Cash availability: for most salaried employees, DCA is automatic — you invest each paycheck as it arrives. This is not a choice between DCA and lump sum; it is the natural mode of accumulation.',
      ]),
      h2('When to use lump sum'),
      p('Lump sum is optimal when:'),
      ul([
        'You have a high risk tolerance and long investment horizon (20+ years)',
        'You can genuinely hold through a 30% decline without selling',
        'The market is not at obvious historic valuation extremes (extremely high CAPE ratio)',
        'The windfall is large enough that optimising matters — 12 months of DCA on $10,000 is a $300 question; on $500,000 it is a $15,000 question',
      ]),
      h2('When DCA makes more sense'),
      p('DCA is the better practical choice when:'),
      ul([
        'You know from past experience that you will panic-sell during a drawdown',
        'You are investing in a historically high-valuation environment and want to reduce the chance of a terrible entry point',
        'The psychological comfort of spreading out is worth the average expected cost',
        'The amount is large relative to your existing portfolio — putting $200,000 into a $50,000 existing portfolio in one shot changes your risk profile dramatically',
      ]),
      h2('The FIRE practitioner approach'),
      p('Most FIRE practitioners resolve this debate practically: invest on payday, automatically. This is DCA in its most consistent form — not a deliberate risk management strategy, but a natural consequence of investing from regular income.'),
      p('For a genuine windfall (inheritance, bonus, home sale proceeds), the pragmatic approach: invest half immediately and the other half over 3–6 months. This captures most of the lump sum upside while providing enough psychological protection to hold through an initial dip.'),
      p('The worst outcome is neither DCA nor lump sum — it is leaving the money in cash for years while trying to time the market. The decision between DCA and lump sum is a fine-tuning question; the decision to invest promptly versus wait is the one that actually matters.'),
    ],
  },
  {
    slug: '401k-rollover-to-ira-what-to-do-with-old-accounts',
    title: '401(k) Rollover to IRA: What to Do With Old Retirement Accounts',
    description: 'How to roll over an old 401(k) to an IRA when you change jobs — the steps, the tax rules, and why consolidating accounts is worth the effort.',
    category: 'Tax Strategy',
    publishedAt: '2026-06-18',
    readTime: '5 min read',
    body: [
      h2('Why old 401(k)s are a problem'),
      p('The average American changes jobs twelve times over a career. Each job with a 401(k) potentially leaves behind a stranded account with a different investment menu, higher fees, and limited control. After several job changes, it is common to have 3–5 old 401(k) accounts at different institutions — each with different login credentials, statements, and fee structures.'),
      p('Rolling old 401(k) accounts into a single IRA consolidates everything, typically lowers fees, expands investment options, and simplifies the management required for FIRE planning.'),
      h2('The four options when leaving a job'),
      p('When you leave an employer with a 401(k), you have four choices:'),
      ul([
        'Leave it in your old employer\'s plan: simple, but you lose access to new contributions and are stuck with their investment menu and fees.',
        'Roll it into your new employer\'s 401(k): good if the new plan has excellent funds and low fees. Also useful if you plan to use the mega backdoor Roth in the new plan.',
        'Roll it into an IRA: the most flexible option for most people. Broader investment selection, likely lower fees, consolidation.',
        'Cash it out: almost always wrong. You pay ordinary income tax on the full amount plus a 10% early withdrawal penalty if under 59½. A $50,000 account cashed out at age 35 might net $30,000 after taxes and penalties.',
      ]),
      h2('The direct rollover process'),
      p('A direct rollover (also called a trustee-to-trustee transfer) moves the money directly from the old 401(k) to the new IRA without you ever touching it. This is the clean, tax-free method.'),
      ol([
        'Open an IRA at your chosen brokerage (Fidelity, Vanguard, Schwab are the common FIRE choices).',
        'Contact your old 401(k) provider and request a direct rollover to your IRA.',
        'Provide the old provider with the receiving IRA account number and institution address.',
        'The old provider sends a check or electronic transfer directly to the new IRA.',
        'Invest the funds in your chosen allocation inside the IRA.',
      ]),
      p('The entire process typically takes 1–3 weeks. No taxes are withheld, and no deadline pressure applies because no funds passed through your hands.'),
      h2('The 60-day rollover: use with caution'),
      p('If you receive a check made out to you personally (indirect rollover), you have 60 days to deposit it into an IRA to avoid taxes and penalties. The old 401(k) provider will withhold 20% for taxes automatically — meaning you must deposit the full original amount (contributing the withheld 20% from other funds) to avoid taxes on the withheld portion.'),
      p('Example: you receive a check for $40,000 (20% withheld from a $50,000 account). To complete the rollover tax-free, you must deposit $50,000 into the IRA within 60 days. The withheld $10,000 comes back as a tax refund later.'),
      p('The direct rollover sidesteps all of this. Request direct rollover whenever possible.'),
      h2('Traditional 401(k) → Traditional IRA vs Roth IRA'),
      p('Rolling a traditional (pre-tax) 401(k) into a traditional IRA is tax-free — you are moving pre-tax money to a pre-tax account. Rolling into a Roth IRA triggers taxes on the full converted amount in the year of conversion. This is a deliberate Roth conversion, not an error.'),
      p('For FIRE planners who retire early: rolling an old 401(k) into a traditional IRA, then converting portions to Roth IRA each year during low-income early retirement years, is the optimal sequence. You get the deferred tax benefit during accumulation and pay conversion taxes at a lower rate in retirement.'),
      h2('The pro-rata rule: the IRA trap'),
      p('If you have existing pre-tax traditional IRA funds, rolling a new traditional 401(k) into the same IRA creates a pro-rata complication for future backdoor Roth conversions. The IRS treats all traditional IRA funds as a combined pool when calculating the taxable portion of a Roth conversion.'),
      p('If you plan to do backdoor Roth IRA contributions (for high earners above the Roth income limit), consider rolling the old 401(k) into your new employer\'s 401(k) instead of an IRA — this keeps the traditional IRA clean for the backdoor strategy.'),
    ],
  },
  {
    slug: 'fat-fire-retiring-on-100k-plus-per-year',
    title: 'Fat FIRE: What It Takes to Retire on $100,000+ Per Year',
    description: 'The math, timeline, and lifestyle behind Fat FIRE — maximum flexibility in retirement and what the extra saving time costs you.',
    category: 'FIRE Basics',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('What is Fat FIRE?'),
      p('Fat FIRE is financial independence with an annual spending budget of $100,000 or more. The name contrasts with Lean FIRE ($25,000–$40,000/year) and regular FIRE ($50,000–$80,000/year). Fat FIRE means retiring with enough that money is not a constraint — you can travel frequently, live in expensive cities, support family members, maintain a larger home, or absorb unexpected large costs without anxiety.'),
      p('The required portfolio at $100,000/year spending and 4%: $2,500,000. At $150,000/year: $3,750,000. These are achievable targets, but they require either a very high income, a very high savings rate, or both — over a longer accumulation period.'),
      h2('The Fat FIRE math'),
      p('Fat FIRE timelines depend heavily on income and savings rate:'),
      ul([
        'Household income $200,000, saving $100,000/year: 18–20 years to $2.5M (starting from zero)',
        'Household income $300,000, saving $150,000/year: 13–15 years',
        'Household income $500,000+, saving $250,000/year: 8–10 years',
        'High-growth startup equity or business sale: accelerated path',
      ]),
      p('For most dual-income professional households earning $150,000–$250,000 combined with a 40–50% savings rate, Fat FIRE is achievable in 20–25 years from the start of serious saving.'),
      h2('What Fat FIRE actually buys'),
      p('The lifestyle advantages of Fat FIRE are concrete:'),
      ul([
        'Travel without budget constraints: business class, extended international trips, expensive destinations without spreadsheet anxiety.',
        'Housing flexibility: ability to live in high-cost cities (NYC, SF, London, Sydney) or maintain a larger home without it threatening the plan.',
        'No healthcare anxiety: premium health insurance, private care, dental and vision without choosing between coverage and spending on other things.',
        'Family support: helping aging parents, funding children\'s education, contributing to family emergencies without portfolio stress.',
        'Margin for lifestyle inflation: if expenses grow from $100,000 to $120,000 over 10 years, a Fat FIRE portfolio absorbs it; a Lean FIRE portfolio may not.',
        'Resilience to bad scenarios: a 30% market crash on $3,000,000 leaves $2,100,000, still enough to sustain $84,000/year at 4%. A Lean FIRE portfolio hit by the same crash may require immediate income.',
      ]),
      h2('The cost: a longer accumulation phase'),
      p('The trade-off for Fat FIRE is straightforward: you work longer. Reaching $2,500,000 instead of $1,000,000 typically takes 5–10 more years, depending on savings rate.'),
      p('At $75,000/year savings rate: $1,000,000 in 10 years, $2,500,000 in 22 years. The difference is 12 years of work. That is a concrete trade-off — 12 additional years of career versus a $100,000+ retirement budget instead of a $40,000 budget.'),
      p('Many people pursuing Fat FIRE are comfortable with this exchange. The question is whether the lifestyle upgrade from Lean to Fat FIRE is worth the additional years — a deeply personal answer.'),
      h2('The two-phase approach to Fat FIRE'),
      p('A common middle path: reach Lean or regular FIRE first, then optionally continue working. This is sometimes called "coasting to Fat FIRE."'),
      p('At $1,000,000 invested at 40, with no additional contributions, the portfolio grows to approximately:'),
      ul([
        '$2,700,000 by age 55 at 7% real return',
        '$3,800,000 by age 60',
        '$5,400,000 by age 65',
      ]),
      p('This means reaching basic financial independence at 40 and continuing to work — or doing part-time/passion work — for 10–15 more years produces a Fat FIRE outcome without the brutal pressure of a mandatory high savings rate throughout.'),
      h2('Is Fat FIRE worth it?'),
      p('The research on wellbeing and spending does not strongly support the value of $100,000+ annual budgets versus $60,000–$80,000 budgets. Beyond a comfortable baseline, incremental spending adds diminishing returns to day-to-day happiness. What Fat FIRE primarily provides is resilience, flexibility, and the ability to absorb unexpected large costs without anxiety.'),
      p('For people with high fixed costs (expensive housing, dependents, health needs), Fat FIRE is not luxury — it is the minimum viable retirement. For people with low fixed costs and geographic flexibility, $60,000–$80,000 often provides nearly identical life quality with a meaningfully shorter accumulation period.'),
      p('The right FIRE target is the one that honestly matches your life. The calculator gives you the number; the harder work is knowing what you actually need.'),
    ],
  },
]
...
const articleMetaBySlug: Record<string, LearnArticleMeta> = {
  ...
  '401k-rollover-to-ira-what-to-do-with-old-accounts': {
    primaryStage: 'building-momentum',
    secondaryStages: ['approaching-fire'],
    relatedCalculators: [
      { href: '/calculators/savings-rate', label: 'Savings Rate Calculator' },
  ...
  'fat-fire-retiring-on-100k-plus-per-year': {
    primaryStage: 'approaching-fire',
    secondaryStages: ['building-momentum'],
    relatedCalculators: [
      { href: '/calculators/4-percent-rule', label: 'FIRE Number Calculator' },
