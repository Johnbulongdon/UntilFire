...
export const learnArticles: LearnArticle[] = [
  ...
  {
    slug: 'real-estate-investing-and-fire-rentals-vs-reits',
    title: 'Real Estate and FIRE: Rentals, REITs, and What Actually Works',
    description: 'How real estate fits into a FIRE portfolio — the realistic pros and cons of rental properties versus REITs, and how to decide which approach fits your plan.',
    category: 'Investing',
    publishedAt: '2026-06-18',
    readTime: '7 min read',
    body: [
      h2('Why real estate attracts FIRE planners'),
      p('Real estate appeals to FIRE planners for three reasons: monthly cash flow from rents, appreciation over time, and leverage — the ability to control a $300,000 asset with $60,000 down. A well-chosen rental property can provide income that partially replaces portfolio withdrawals, extends the FIRE timeline, and diversifies away from pure equity market exposure.'),
      p('The reality is more nuanced. Real estate is a business, not a passive investment. Whether the real estate path fits FIRE depends heavily on your tolerance for landlord work, your local market, and how you compare the returns honestly against a simple index fund.'),
      h2('Rental properties: the active approach'),
      p('Direct rental property ownership provides the highest potential return but requires meaningful ongoing work: tenant management, maintenance coordination, vacancy periods, and occasional capital expenditures (new roof, HVAC replacement, appliances).'),
      p('A realistic return calculation for a rental property:'),
      ul([
        'Gross yield: annual rent divided by purchase price (a $1,800/month property bought for $250,000 = 8.6% gross yield)',
        'Net yield after expenses: subtract property taxes (~1.2%), insurance (~0.5%), maintenance (~1%), management fees if hired (8–10% of rent), and vacancy (~5%). Net yield: often 4–6%',
        'Cash-on-cash return: net annual cash flow divided by down payment. On a $60,000 down payment generating $6,000/year net: 10% cash-on-cash — but this ignores the leveraged risk',
        'Total return including appreciation: varies enormously by market and era. National average appreciation: ~3–4% annually, roughly matching inflation',
      ]),
      p('The leveraged return can be attractive, but leverage amplifies losses too. A property that drops 10% in value wipes out the entire 20% equity position if leverage is 80%.'),
      h2('The hidden costs of being a landlord'),
      p('Most rental property projections underestimate these items:'),
      ul([
        'Vacancy: even well-managed properties average 5–10% vacancy. Factor 1 month empty per year minimum.',
        'CapEx (capital expenditures): roofs, HVAC, appliances, and plumbing all need replacement. Budget 1–2% of property value per year.',
        'Time cost: even with a property manager, expect 5–10 hours/month minimum per property for oversight, decisions, and unexpected issues.',
        'Eviction and problem tenants: rare but expensive. One difficult tenant can cost $5,000–$15,000 in legal fees, lost rent, and repairs.',
        'Illiquidity: unlike an index fund, you cannot sell 10% of a rental property in a down year.',
      ]),
      h2('REITs: real estate without landlord work'),
      p('A Real Estate Investment Trust (REIT) is a company that owns income-producing real estate and distributes most of its income to shareholders. You buy shares like a stock — instant liquidity, no property management, full diversification across hundreds of properties.'),
      p('REIT advantages for FIRE investors:'),
      ul([
        'Total returns historically comparable to direct real estate (8–10% annually, including dividends)',
        'No management work, no tenants, no CapEx surprises',
        'Liquidity: sell any time at market price',
        'Diversification: a REIT index holds office, industrial, apartment, retail, healthcare, and data center properties',
        'Available in tax-advantaged accounts (buy REIT index funds in your IRA or 401k)',
      ]),
      p('REIT disadvantages: dividends are taxed as ordinary income (not the favorable capital gains rate), and REITs correlate more with the stock market than direct real estate in short-term downturns.'),
      h2('The honest comparison'),
      p('For most FIRE planners, a REIT index fund (like VNQ or a total market fund with REIT exposure) beats direct rental property after accounting for the time cost. At $50/hour of your time, 10 hours per month managing a property costs $6,000/year in opportunity cost — which erases much of the return premium over REITs.'),
      p('Direct rental property makes sense for FIRE if: you enjoy the work, you have a structural edge (access to below-market deals, local market knowledge, or renovation skills), or you want income that is less correlated with public markets.'),
      h2('House hacking: the FIRE-specific real estate strategy'),
      p('House hacking — buying a duplex or multi-family home, living in one unit, and renting the others — is the most FIRE-efficient real estate strategy. It lets you access owner-occupant mortgage terms (lower down payment, better interest rates), reduce your own housing cost dramatically, and build equity simultaneously.'),
      p('A house hacker who buys a duplex for $400,000 with 5% down, lives in one unit, and rents the other for $1,800/month can cover most of their housing cost or eliminate it entirely. Their effective housing cost might be $0–$400/month instead of $2,500/month. That difference — $2,100/month — invested over 10 years at 7% returns is over $350,000 in additional wealth.'),
    ],
  },
  {
    slug: 'maximizing-tax-advantaged-accounts-401k-ira-hsa',
    title: 'Maximizing Tax-Advantaged Accounts: 401(k), IRA, and HSA',
    description: 'The contribution limits, strategies, and sequencing for getting the most out of every tax-sheltered dollar — the highest-leverage move available to most FIRE planners.',
    category: 'Tax Strategy',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('Why tax-advantaged accounts are the highest-leverage tool'),
      p('A dollar invested in a tax-advantaged account is worth more than a dollar invested in a taxable account — often significantly more over a 20–30 year horizon. Tax deferral or tax-free growth eliminates the annual drag of taxes on dividends and capital gains distributions, allowing full compounding on the gross return.'),
      p('The difference is substantial: $10,000 invested at 7% per year for 30 years grows to $76,000 in a taxable account (assuming 25% annual tax drag) versus $96,000 in a tax-free account. The tax-advantaged account delivers 26% more — for doing nothing differently except using the right account type.'),
      h2('The 2024 contribution limits'),
      p('Key annual contribution limits (2024 values; adjusted annually for inflation):'),
      ul([
        '401(k): $23,000 employee contribution; $69,000 total including employer match and after-tax contributions',
        'IRA (Traditional or Roth): $7,000 ($8,000 if age 50+)',
        'HSA: $4,150 single / $8,300 family (requires enrollment in a High Deductible Health Plan)',
        'SEP IRA (self-employed): 25% of net self-employment income up to $69,000',
        'Solo 401(k) (self-employed): $23,000 employee + 25% of net profit, up to $69,000 total',
      ]),
      h2('The optimal contribution sequence'),
      p('For a typical FIRE saver with an employer 401(k) and eligibility for a Roth IRA:'),
      ol([
        'Contribute to 401(k) up to the full employer match — this is a 50–100% instant return, highest priority.',
        'Max the HSA if on a qualifying HDHP — triple tax benefit beats everything else.',
        'Max the Roth IRA — tax-free growth, most flexible access, best for long time horizons.',
        'Return to 401(k) and max it — tax deferral on up to $23,000 per year.',
        'If eligible: after-tax 401(k) contributions converted immediately to Roth (mega backdoor Roth).',
        'Invest remainder in taxable brokerage.',
      ]),
      h2('Traditional vs Roth: which is better for FIRE?'),
      p('The traditional vs Roth decision depends on your expected tax bracket now versus in retirement:'),
      ul([
        'Traditional (deduct now, pay tax on withdrawal): best if you are in a high bracket now (22%+) and expect lower rates in retirement.',
        'Roth (pay tax now, withdraw tax-free): best if you are in a low bracket now or expect higher taxes in retirement.',
        'For early FIRE: Roth usually wins because early retirees often have zero or low taxable income, making Roth conversions and withdrawals tax-free. The gap years of early retirement are a window to access traditional money at very low rates.',
      ]),
      p('Many FIRE planners use both: contribute to traditional 401(k) during high-earning years to reduce current taxes, then convert to Roth during early retirement low-income years via the Roth conversion ladder.'),
      h2('The mega backdoor Roth'),
      p('If your 401(k) plan allows after-tax contributions (beyond the standard $23,000 limit) and in-service withdrawals or conversions, you can contribute up to $46,000 more in after-tax dollars and immediately convert them to Roth. This is the mega backdoor Roth.'),
      p('Not all 401(k) plans allow it — check your plan documents or ask HR. When available, it is one of the most powerful FIRE accelerators: an additional $46,000/year of tax-free growth on top of the standard limits.'),
      h2('The backdoor Roth IRA'),
      p('High earners above the Roth IRA income limit ($161,000 single / $240,000 married in 2024) can still access Roth via the backdoor: contribute to a non-deductible traditional IRA, then immediately convert to Roth. The conversion is taxable only on gains (nearly zero if done immediately).'),
      p('Important: the pro-rata rule applies if you have existing pre-tax traditional IRA funds. The conversion is taxed proportionally across all traditional IRA funds, not just the non-deductible contribution. Rolling pre-tax IRA funds into a 401(k) before the backdoor Roth can avoid this.'),
      h2('HSA: the triple tax account'),
      p('The HSA is the most tax-efficient account available:'),
      ul([
        ...
        'At age 65, withdrawals for any reason are taxed as ordinary income (like a traditional IRA) — no penalty',
      ]),
      p('The optimal strategy: contribute the maximum each year, invest in low-cost index funds inside the HSA, and pay all current medical expenses out of pocket. Let the HSA compound for decades. In retirement, use it as a tax-free medical expense account or a bonus traditional IRA.'),
    ],
  },
  {
    slug: 'lean-fire-achieving-fire-on-modest-income',
    title: 'Lean FIRE: Achieving Financial Independence on a Modest Income',
    description: 'How Lean FIRE works, what a sub-$40,000 retirement budget actually looks like, and the tradeoffs of reaching financial independence with a smaller portfolio.',
    category: 'FIRE Basics',
    publishedAt: '2026-06-18',
    readTime: '6 min read',
    body: [
      h2('What is Lean FIRE?'),
      p('Lean FIRE is financial independence on a lean budget — typically defined as annual spending below $40,000 for a single person or $50,000 for a couple. The FIRE number is smaller (a $35,000 annual spend requires $875,000 at 4%), so the timeline is shorter and achievable at lower incomes. The trade-off is less buffer for lifestyle changes, unexpected costs, or spending increases.'),
      p('Lean FIRE is not deprivation — it is intentionality. Many Lean FIRE practitioners report higher life satisfaction than their high-spending peers, because they have optimised spending around what they actually value.'),
      h2('Who Lean FIRE is for'),
      p('Lean FIRE fits people who:'),
      ul([
        'Have low fixed costs (no mortgage, or very low rent via geographic arbitrage, house hacking, or rural living)',
        'Value time and freedom over lifestyle upgrades and status goods',
        'Are healthy and have low expected healthcare costs',
        'Are willing to stay flexible — to pick up occasional work if spending exceeds expectations',
        'Live in a lower cost-of-living area domestically or internationally',
      ]),
      p('It is less suitable for people with dependents, significant medical needs, or strong preferences for high-cost activities or locations.'),
      h2('What a $35,000/year budget looks like'),
      p('A $35,000/year Lean FIRE budget in a mid-cost US city might look like:'),
      ul([
        'Housing: $900/month (owned outright after mortgage payoff, or low-cost rental)',
        'Food: $400/month (mostly home cooking)',
        'Transportation: $200/month (paid-off older car, minimal driving)',
        'Healthcare: $250/month (ACA marketplace with subsidies)',
        'Utilities: $150/month',
        'Discretionary (travel, entertainment, personal): $$1,000/month',
      ]),
      p('Many people in lower cost-of-living areas or with paid-off housing achieve this comfortably. It requires living in a location where it is possible, not white-knuckling through expensive urban costs.'),
      h2('The FIRE number math'),
      p('The smaller FIRE target is the defining feature of Lean FIRE:'),
      ul([
        '$25,000/year spending → $625,000 FIRE number',
        '$30,000/year spending → $750,000 FIRE number',
        '$35,000/year spending → $875,000 FIRE number',
        '$40,000/year spending → $1,000,000 FIRE number',
      ]),
      p('For a household saving $30,000/year, reaching $875,000 takes roughly 15–16 years from zero. Reaching $1,500,000 (a more comfortable FIRE target) takes 25+ years. The Lean FIRE target is achievable at relatively modest income levels by people who prioritise the timeline.'),
      h2('The key risks of Lean FIRE'),
      p('The smaller portfolio leaves less margin for:'),
      ul([
        'Spending inflation: if annual expenses grow from $35,000 to $50,000 due to family changes, health costs, or lifestyle shifts, the portfolio may not sustain the new level.',
        'Extended bear markets: a 30% portfolio drop on $875,000 leaves $612,500, which at 4% supports only $24,500 in spending. The buffer is thin.',
        'Unexpected large expenses: home repair, health emergency, or family obligation can materially stress a lean portfolio.',
        'Healthcare cost spikes: ACA subsidies are income-dependent. If income rises (part-time work, investment gains), subsidies shrink.',
      ]),
      h2('Strategies to make Lean FIRE more robust'),
      p('The most successful Lean FIRE practitioners build in resilience through:'),
      ul([
        'Income flexibility: staying available for occasional consulting or part-time work, not fully exiting the labour market.',
        'Spending flexibility: having a budget that can flex down by 20% in a bad market year without misery.',
        'Paid-off housing: eliminating housing cost as a variable is the single biggest stability factor.',
        'Low withdrawal rate: targeting 3–3.5% instead of 4% on the lean portfolio adds meaningfully to survival probability on a long horizon.',
      ]),
      h2('Lean FIRE vs barista FIRE'),
      p('The practical difference between Lean FIRE and Barista FIRE is whether you choose ongoing work. Lean FIRE assumes the portfolio covers all spending. Barista FIRE assumes small ongoing income covers part of it.'),
      p('Many practitioners start at Lean FIRE and find they pick up occasional paid work naturally — through passion projects, consulting, or creative work. Over time, the distinction between "retired" and "occasionally working on what I want" becomes irrelevant. The financial independence is real; the label is not.'),
    ],
  },
]
...
const articleMetaBySlug: Record<string, LearnArticleMeta> = {
  ...
  'real-estate-investing-and-fire-rentals-vs-reits': {
    primaryStage: 'building-momentum',
    secondaryStages: ['approaching-fire'],
    relatedCalculators: [
  ...
  'lean-fire-achieving-fire-on-modest-income': {
    primaryStage: 'starting-out',
    secondaryStages: ['building-momentum', 'approaching-fire'],
    relatedCalculators: [
      { href: '/calculators/4-percent-rule', label: 'FIRE Number Calculator' },
      { href: '/?source=learn-lean-fire', label: 'FIRE Calculator' },
    ],
  },
}
