...
export const learnArticles: LearnArticle[] = [
  ...
  {
    slug: 'bucket-strategy-retirement-income',
    title: 'The Bucket Strategy: Structuring Retirement Income to Survive Market Crashes',
    description: 'How splitting your retirement portfolio into short, medium, and long-term buckets reduces sequence risk and gives you the psychological clarity to stay invested through downturns.',
    category: 'Withdrawal Strategy',
    publishedAt: '2026-06-18',
    readTime: '7 min read',
    body: [
      h2('What is the bucket strategy?'),
      p('The bucket strategy divides your retirement portfolio into three separate pools — often called buckets — each with a different time horizon and investment type. The goal is to ensure you always have stable, accessible cash for near-term expenses while your growth assets remain invested long enough to recover from downturns.'),
      p('Harold Evensky popularised the approach in the 1980s. It has remained widely used because it solves a practical problem: retirees who need to spend money cannot always wait for markets to recover before selling investments. The bucket strategy creates a buffer that makes waiting possible.'),
      h2('The three buckets'),
      h3('Bucket 1: Immediate (1–2 years of spending)'),
      p('Held in cash or a high-yield savings account. This is the money you live on right now. You never sell investments to fund living expenses — you spend from this bucket. When it gets low, you refill it by selling from Bucket 2 or 3, depending on market conditions. Holding 1–2 years of expenses in cash means a significant market downturn does not force you to sell stocks at a loss.'),
      h3('Bucket 2: Intermediate (years 3–10 of spending)'),
      p('Held in bonds, bond funds, or conservative income-generating assets. This bucket refills Bucket 1 when needed. Because bonds are less volatile than stocks, selling from this bucket during an equity bear market avoids crystallising stock losses. The bond allocation also generates income (coupon payments or dividends) that flows into Bucket 1 naturally.'),
      h3('Bucket 3: Long-term (10+ years of spending)'),
      p('Held almost entirely in equities — index funds, REITs, or other growth assets. This bucket is not touched for the first decade of retirement. Its job is to grow and eventually refill Bucket 2 as bonds are spent down. Because you have a long horizon before touching this money, you can ride out severe market downturns without selling.'),
      h2('How refilling works'),
      p('The mechanics of moving money between buckets is where the real sequence-risk protection happens:'),
      ul([
        'In up markets: sell from Bucket 3 (equities) to refill Bucket 2 (bonds), and sell from Bucket 2 to refill Bucket 1 (cash). You are selling stocks when they are high.',
        'In down markets: spend down Bucket 1 without touching equities. If the crash extends, draw from Bucket 2 (bonds), which typically holds value or even rises during equity crashes. Give Bucket 3 time to recover.',
        'After recovery: once stocks recover, resume selling equities to refill the other buckets.',
      ]),
      h2('Bucket strategy vs total return approach'),
      p('The alternative to the bucket strategy is the total return approach: hold a single balanced portfolio, withdraw a fixed percentage each year, and rebalance annually. Research shows the total return approach produces equivalent or slightly superior mathematical outcomes — the buckets do not change the underlying return of the assets.'),
      p('The bucket strategy wins on psychology. Retirees who know they have two years of cash in Bucket 1 are far less likely to panic-sell equities during a crash than those watching a single portfolio value decline. The emotional benefit of the bucket strategy often outweighs the mechanical equivalence with total return in practice.'),
      h2('Setting up the buckets for FIRE'),
      p('For a FIRE retiree spending $60,000 per year:'),
      ul([
        'Bucket 1: $60,000–$120,000 in a high-yield savings account (1–2 years of spending)',
        'Bucket 2: $180,000–$300,000 in bond index funds (3–5 years of additional spending)',
        'Bucket 3: Remaining portfolio (80%+) in equity index funds',
      ]),
      p('The exact split depends on your comfort with volatility and other income sources. Retirees with Social Security or rental income can run smaller buckets because some living expenses are covered regardless of portfolio performance.'),
    ],
  },
  {
    slug: 'variable-spending-guardrails-dynamic-withdrawal',
    title: 'Variable Spending and Guardrails: The Smarter Way to Withdraw in Retirement',
    description: 'Why rigid 4% withdrawals are not the only option — how dynamic spending strategies like the Guyton-Klinger guardrails reduce portfolio depletion risk while preserving lifestyle flexibility.',
    category: 'Withdrawal Strategy',
    publishedAt: '2026-06-18',
    readTime: '7 min read',
    body: [
      h2('The problem with a fixed withdrawal rate'),
      p('The 4% rule assumes you withdraw a fixed, inflation-adjusted dollar amount every year regardless of market conditions. This simplicity is valuable, but it has a limitation: in a severe bear market, continuing to withdraw the same amount sells more shares at depressed prices, accelerating portfolio depletion.'),
      p('Dynamic withdrawal strategies respond to portfolio performance. In good years, you can spend more. In bad years, you cut back — avoiding the worst outcomes that fixed withdrawals can produce in severe downturns.'),
      h2('The Guyton-Klinger guardrails method'),
      p('The most widely cited dynamic strategy is the Guyton-Klinger guardrails system, developed by financial planner Jonathan Guyton and researcher William Klinger. It adjusts withdrawals based on two trigger rules:'),
      h3('The prosperity rule'),
      p('If your current withdrawal rate falls below a lower guardrail (typically 80% of your initial withdrawal rate as a percentage of current portfolio), you can increase spending by a set amount — often 10%. This allows you to spend more in strong markets when the portfolio has grown well beyond expectations.'),
      h3('The capital preservation rule'),
      p('If your current withdrawal rate rises above an upper guardrail (typically 120% of your initial rate), you cut spending by a set amount — often 10%. This reduces withdrawals when the portfolio has been depleted by market losses, giving it time to recover.'),
      p('In practice, most retirees spend years between the guardrails without triggering either rule. But the rules provide a defined response when conditions push the portfolio toward stress, avoiding the binary choice between "keep spending the same" and "panic and cut everything."'),
      h2('A simple guardrails example'),
      p('Starting withdrawal: $50,000 per year from a $1,250,000 portfolio (4% rate). Lower guardrail: $40,000 (cut 10%). Upper guardrail: $60,000 (increase 10%).'),
      ul([
        'Year 3: portfolio has grown to $1,500,000. Current $52,000 withdrawal (inflation-adjusted) is 3.5% of portfolio — well below the upper guardrail trigger. No change.',
        'Year 5: market crashes. Portfolio drops to $900,000. Current $55,000 withdrawal is 6.1% — above the 4.8% upper guardrail (120% of initial 4%). Trigger: cut spending by 10% to $49,500.',
        'Year 8: portfolio recovers to $1,300,000. Current $48,000 withdrawal is 3.7% — still between guardrails. No change.',
      ]),
      h2('Other variable spending approaches'),
      ul([
        'Ceiling and floor: set a minimum spending floor (never go below) and a maximum ceiling (never take more), with adjustments based on portfolio balance. Simpler than Guyton-Klinger.',
        'RMD-based: withdraw the same percentage the IRS requires for Required Minimum Distributions each year. Simple, but does not distinguish between good and bad markets.',
        'Percentage of portfolio: withdraw 4% of the current portfolio balance each year rather than an inflation-adjusted dollar amount. Spending varies with markets automatically — bad years produce lower withdrawals without any rule-based trigger.',
      ]),
      h2('Who benefits most from dynamic withdrawal?'),
      p('Variable spending works best for retirees with spending flexibility — those who can tolerate cutting discretionary expenses by 10–15% in a bad year. If your spending is mostly fixed (rent, insurance, food), dynamic withdrawal is harder to implement.'),
      p('For FIRE retirees with a mix of fixed necessities and discretionary spending, the guardrails approach often works well: necessities are funded by a baseline allocation, and discretionary spending (travel, restaurants, hobbies) flexes with the guardrails. A bad market year means fewer vacations, not skipped meals.'),
      h2('Dynamic spending and the Trinity Study'),
      p('The original Trinity Study used fixed withdrawals. When researchers model dynamic spending strategies with guardrails, sustainable withdrawal rates often increase to 5–5.5% with comparable portfolio survival rates. The flexibility of reducing spending in bad years substantially improves long-run outcomes.'),
    ],
  },
  {
    slug: 'annuities-fire-perspective-when-they-make-sense',
    title: 'Annuities and FIRE: When They Make Sense (and When They Do Not)',
    description: 'An honest look at annuities from a FIRE perspective — the types that are worth considering, the types to avoid, and how guaranteed income fits into an early retirement plan.',
    category: 'Withdrawal Strategy',
    publishedAt: '2026-06-18',
    readTime: '7 min read',
    body: [
      h2('Why the FIRE community is sceptical of annuities'),
      p('Most FIRE content dismisses annuities, and with good reason: the annuity market is filled with complex, high-commission products that transfer wealth from investors to insurance companies and advisers. Variable annuities with surrender charges, indexed annuities with opaque caps, and whole-life policies sold as investment vehicles have rightfully earned distrust.'),
      p('But "most annuities are bad products" is not the same as "no annuity is ever useful." For specific situations, a simple annuity can play a genuine role in a retirement income plan — particularly for managing longevity risk.'),
      h2('What an annuity actually does'),
      p('An annuity is a contract with an insurance company: you give them a lump sum, and they pay you a guaranteed income stream for a defined period or for the rest of your life. The insurance company pools the longevity risk across many policyholders — those who die early subsidise the payments for those who live long.'),
      p('The key benefit is longevity insurance: an annuity guarantees you do not outlive your money. No investment portfolio can make that promise with certainty. A portfolio can be depleted; an annuity paying lifetime income cannot be spent down.'),
      h2('Types of annuities: what to know and what to avoid'),
      h3('Single Premium Immediate Annuity (SPIA) — the simple kind'),
      p('You pay a lump sum, and income starts immediately. No surrender charges, no hidden fees, no investment subaccounts. SPIAs are transparent: you can get quotes online, compare insurers by credit rating, and know exactly what income you get. For a retiree in their 60s or 70s who wants a simple guaranteed income floor, SPIAs are worth considering.'),
      h3('Deferred Income Annuity (DIA) / Longevity annuity — useful for late-stage FIRE'),
      p('You pay now, but income does not start until a future date — often age 80 or 85. A longevity annuity bought at 65 for a small premium can guarantee income starting at 85, covering the tail risk of living to 90+. The IRS allows up to $135,000 in an IRA to be used for a qualifying longevity annuity (QLAC) without being subject to RMDs — a niche but legitimate tax planning tool.'),
      h3('Variable and indexed annuities — usually avoid'),
      p('Variable annuities invest your premium in subaccounts and pass market risk to you — but charge 2–4% per year in fees. Indexed annuities promise market-linked growth with a floor, but cap your upside and are complicated to evaluate. Both product types generate high commissions and are routinely mis-sold. In most cases, a simple index fund portfolio outperforms these products net of fees.'),
      h2('The FIRE case for a partial annuity'),
      p('A common framework: cover fixed necessities with guaranteed income, invest the rest for growth. If your fixed monthly expenses are $3,500 and Social Security provides $1,500, you have a $2,000 monthly gap. One option: buy a SPIA to fill that gap, then invest the remaining portfolio 100% in equities. This removes the sequence risk from your fixed expenses entirely.'),
      p('The cost of that guarantee is the premium paid and the upside foregone on those funds. If you live to 95, the annuity pays extremely well. If you live to 75, you would have been better off investing. This trade-off is the fundamental annuity decision.'),
      h2('For early FIRE retirees: timing matters'),
      p('Annuities bought in your 40s or 50s produce poor income relative to the premium because the insurance company must cover more years. SPIAs bought before age 60–65 are almost never cost-effective. For FIRE retirees who leave work early, the relevant annuity question is typically deferred: do I want to buy longevity insurance in my 60s or 70s to protect against living past 85?'),
      p('The practical FIRE approach: build the full portfolio, use dynamic withdrawal strategies for the accumulation and early retirement years, and revisit annuities as you age into your 60s and 70s if guaranteed income would provide meaningful security without sacrificing too much long-run return.'),
    ],
  },
]
...
const articleMetaBySlug: Record<string, LearnArticleMeta> = {
  ...
  'variable-spending-guardrails-dynamic-withdrawal': {
    primaryStage: 'living-in-fire',
    secondaryStages: ['approaching-fire'],
    relatedCalculators: [
      { href: '/calculators/4-percent-rule', label: 'Safe Withdrawal Calculator' },
  ...
  'annuities-fire-perspective-when-they-make-sense': {
    primaryStage: 'living-in-fire',
    secondaryStages: ['approaching-fire'],
    relatedCalculators: [
      { href: '/calculators/4-percent-rule', label: 'FIRE Number Calculator' },
      { href: '/?source=learn-annuities', label: 'FIRE Calculator' },
    ],
  },
}
