...
export const learnArticles: LearnArticle[] = [
  ...
  {
    slug: 'healthcare-in-early-retirement-aca-cobra-coverage',
    title: 'Healthcare in Early Retirement: ACA, COBRA, and Your Options',
    description: 'Healthcare is the largest practical obstacle to early retirement for most Americans. Here is how to understand your options, estimate costs, and build healthcare into your FIRE plan.',
    category: 'Planning',
    publishedAt: '2026-06-17',
    readTime: '7 min read',
    body: [
      h2('Why healthcare is the central early retirement question'),
      p('For workers in traditional retirement at 65, Medicare solves the healthcare problem. For early retirees, Medicare is 15–30 years away. In the gap, you are responsible for your own health insurance — in a market that can be expensive, complicated, and politically uncertain.'),
      p('Healthcare is the reason many people who could mathematically retire do not. It is also the area where careful planning creates the most leverage: well-managed healthcare costs can be $5,000–$10,000 per year for an early retiree; poorly managed, they can be $30,000–$40,000. The difference is planning, not luck.'),
      h2('COBRA: the bridge for 18 months'),
      p('When you leave an employer, the Consolidated Omnibus Budget Reconciliation Act (COBRA) allows you to continue your employer-sponsored health plan for up to 18 months. You pay the full premium — including the portion your employer previously covered — plus a 2% administrative fee.'),
      p('COBRA costs are often shocking: a plan that cost you $200/month in employee contribution may cost $1,500–$2,000/month under COBRA. However, COBRA has one major advantage: it is the exact same plan you already have, with no underwriting, coverage changes, or network disruption. For people with ongoing care or treatments, this continuity can matter significantly.'),
      ul([
        'Duration: 18 months (36 months in certain disability or divorce situations)',
        'Deadline: you must elect COBRA within 60 days of losing employer coverage',
        'Cost: full premium + 2% (typically $1,200–$2,500/month for individual, $2,500–$4,500/month for family)',
        'Best use: transition coverage while setting up ACA or if you have specific ongoing care needs',
      ]),
      h2('The ACA marketplace: your primary option'),
      p('The Affordable Care Act marketplace (healthcare.gov) offers individual and family health insurance plans independent of employment. ACA plans cannot deny coverage or charge more for pre-existing conditions. Open enrollment runs November 1 through January 15 each year; losing job-based coverage triggers a Special Enrollment Period.'),
      h3('ACA plan tiers'),
      ul([
        'Bronze: lowest premium, highest deductible/out-of-pocket (~$7,000–$9,000 individual OOP max)',
        'Silver: moderate premium and deductible; required tier to access cost-sharing reductions',
        'Gold: higher premium, lower deductible (~$1,500–$3,500)',
        'Platinum: highest premium, lowest deductible and copays',
      ]),
      p('For early retirees with low taxable income, Silver plans with cost-sharing reductions often provide the best value — lower out-of-pocket limits at modest premium increases over Bronze.'),
      h3('ACA premium tax credits'),
      p('The most powerful feature of ACA for early retirees is income-based premium subsidies. For 2024, households with income below 400% of the federal poverty line (FPL) qualify for premium tax credits that reduce monthly premiums. The American Rescue Plan (2021) and Inflation Reduction Act (2022) extended enhanced subsidies through 2025, capping premiums at 8.5% of income for all income levels.'),
      ul([
        'Family of two, income $40,000 (~200% FPL): estimated net premium after credit ~$150–$200/month',
        'Family of two, income $60,000 (~300% FPL): estimated net premium ~$350–$450/month',
        'Family of two, income $80,000 (~400% FPL): estimated net premium ~$600–$750/month',
        'Above 400% FPL: premium capped at 8.5% of income regardless of cost (through 2025)',
      ]),
      h2('Income management and ACA subsidies'),
      p('ACA subsidies are based on Modified Adjusted Gross Income (MAGI). For early retirees drawing from taxable accounts and managing Roth conversions carefully, taxable income can be significantly lower than total spending — because Roth withdrawals and return of principal in taxable accounts do not count as income.'),
      p('The implication: an early retiree spending $70,000/year might have MAGI of $40,000 if they are drawing from Roth accounts and living on previously taxed principal. That $40,000 MAGI qualifies for substantial ACA subsidies that $70,000 in apparent spending would not.'),
      p('This is "ACA income harvesting": structuring which accounts you draw from to minimize MAGI and maximize healthcare subsidies. The interaction with Roth conversion strategy and capital gains harvesting makes this a three-dimensional optimization that rewards planning.'),
      h2('The Medicaid cliff'),
      p('Medicaid is available to individuals and families with income below roughly 138% of FPL ($20,120 for an individual, $41,400 for a family of four in 2024, in expansion states). Medicaid is free — no premiums, very low cost-sharing.'),
      p('The problem: the "Medicaid cliff" means that income $1 above the threshold disqualifies you from Medicaid and makes you eligible for ACA subsidies instead. For early retirees managing income precisely, accidentally falling into Medicaid (by having lower-than-planned income) and then having unexpected expenses is a scenario worth modeling.'),
      p('In non-expansion states (primarily southern US states that did not expand Medicaid under the ACA), the coverage gap is more severe: income too high for Medicaid but potentially too low for meaningful ACA subsidies. This is a significant planning consideration for early retirees choosing where to live.'),
      h2('Short-term health plans and alternatives'),
      p('Short-term health insurance plans (duration: 3–12 months, renewable) are less expensive than ACA plans but offer significantly fewer protections: they can deny coverage for pre-existing conditions, exclude essential health benefits, and have high out-of-pocket exposure. For healthy early retirees in very low income ranges, they provide catastrophic coverage at lower premiums — but the risk of a serious diagnosis or accident is real. These are best used as short-gap coverage only.'),
      p('Health sharing ministries are another alternative: member pools that share healthcare costs outside the insurance framework. They have no coverage guarantees and exclude pre-existing conditions, but monthly contributions are significantly lower than ACA premiums. Appropriate only for healthy individuals with very low risk tolerance for healthcare uncertainty.'),
      h2('Building healthcare into your FIRE number'),
      p('The conservative approach: add $12,000–$20,000 per year to your annual spending estimate specifically for healthcare, depending on family size and desired coverage. Multiply by 25 for FIRE number impact: $15,000 × 25 = $375,000 additional portfolio required.'),
      p('The optimised approach: model healthcare costs based on expected income management strategy. If you expect $40,000 MAGI in early retirement, current ACA subsidies may reduce premiums to $2,000–$4,000/year. Add $4,000–$6,000 for estimated out-of-pocket costs. Total: $6,000–$10,000/year. At 25×, this requires $150,000–$250,000 in portfolio — significantly less than the conservative estimate.'),
      p('Healthcare law in the US has changed repeatedly. Build in a buffer and revisit the assumption annually.'),
    ],
  },
  {
    slug: 'real-estate-vs-index-funds-which-builds-wealth-faster',
    title: 'Real Estate vs Index Funds: Which Builds Wealth Faster?',
    description: 'The two most popular wealth-building strategies compared honestly — returns, risk, liquidity, tax treatment, and which makes more sense for FIRE.',
    category: 'Investing',
    publishedAt: '2026-06-17',
    readTime: '6 min read',
    body: [
      h2('The debate and why it persists'),
      p('Real estate investors swear by property. Index fund investors swear by the market. Both camps have compelling success stories, and both camps have motivated reasoning. The honest answer is that both can build significant wealth — but they have very different characteristics that make one or the other better for different people and different FIRE plans.'),
      h2('Historical returns: a level comparison'),
      p('Comparing real estate and stock market returns requires care because real estate returns are often presented favourably (by including leverage) or unfavourably (by ignoring leverage). Here is a fair comparison:'),
      h3('US stock market (S&P 500 / Total Market Index)'),
      ul([
        'Historical nominal return: ~10% per year (1926–2023)',
        'Historical real (inflation-adjusted) return: ~7% per year',
        'No leverage required to achieve these returns',
        'Fully liquid — can sell any amount any day',
        'Virtually zero ongoing management time',
      ]),
      h3('Residential real estate (unleveraged)'),
      ul([
        'Historical nominal appreciation: ~4% per year (Case-Shiller index)',
        'Historical real appreciation: ~1% per year (barely above inflation)',
        'Add rental yield (gross ~5–8%, net ~3–5% after expenses) for total return',
        'Unleveraged total real return: ~4–6% per year (comparable to bonds, not stocks)',
      ]),
      h3('Residential real estate (with leverage/mortgage)'),
      ul([
        'With a 20% down payment, you control a $500,000 property with $100,000',
        'If the property appreciates 4%, you gain $20,000 on a $100,000 investment = 20% return on equity',
        'Leverage dramatically amplifies returns — and losses',
        'This is why real estate feels like it outperforms: you are comparing a leveraged asset to an unleveraged one',
      ]),
      p('The key insight: real estate returns are largely a leverage story. If you applied equivalent leverage to an index fund portfolio (2:1 or 3:1 margin), you would generate similar or higher returns — with more liquidity and less management overhead. Leverage is a tool, not an asset class advantage.'),
      h2('The real estate advantages'),
      ul([
        'Leverage: mortgage financing allows control of a large asset with a small down payment',
        'Tax advantages: mortgage interest deduction, property tax deduction, depreciation deduction (on rental properties), 1031 exchanges to defer capital gains indefinitely',
        'Inflation hedge: rents and property values tend to rise with inflation; fixed-rate mortgage payments do not',
        'Forced savings: a mortgage payment forces capital accumulation that many people would otherwise spend',
        'Local market expertise: skilled investors with specific local knowledge can identify undervalued properties',
        'Tangible asset: some people feel more comfortable owning something they can see and touch',
      ]),
      h2('The index fund advantages'),
      ul([
        'Liquidity: sell any amount at any time without transaction costs or delays',
        'Diversification: one fund holds thousands of companies across sectors and geographies',
        'Zero management: no tenants, repairs, vacancies, or local market research required',
        'Low minimum: can invest $1 in a total market index ETF; real estate requires $20,000–$100,000+ to start',
        'Tax efficiency: long-term capital gains rates (0–23.8%); no depreciation recapture; easy tax-loss harvesting',
        'True passive: the 4% withdrawal rule is designed for liquid portfolio assets, not illiquid properties',
      ]),
      h2('For FIRE specifically: why index funds usually win'),
      p('The FIRE framework is built around the 4% rule — which assumes you can withdraw from a liquid portfolio without disrupting its structure. Real estate does not fit this model cleanly:'),
      ul([
        'You cannot withdraw 4% of a rental property — you sell the property or refinance, both of which are complex and costly',
        'Real estate income is variable: vacancies, repairs, and problem tenants create cashflow disruption',
        'Managing properties in early retirement is not passive — it is a part-time job',
        'Concentration risk: a few properties in one city creates significant exposure to local market conditions',
      ]),
      p('For FIRE income, the index fund portfolio + 4% rule is simpler, more reliable, and truly passive. Real estate can supplement or accelerate the FIRE journey — particularly in the accumulation phase — but it is rarely the most efficient vehicle for the portfolio you draw down in retirement.'),
      h2('The hybrid approach most FIRE practitioners use'),
      p('The most common real estate + FIRE combination: own a primary residence (building home equity, removing rent from the budget), invest FIRE portfolio in index funds, and optionally add one or two rental properties during accumulation for additional cashflow and leverage benefit. At or near FIRE, sell rental properties and roll proceeds into the index fund portfolio via a 1031 exchange or simply pay capital gains and simplify.'),
      p('This approach captures the leverage and forced-savings benefits of real estate during accumulation, while ensuring the retirement portfolio is liquid and manageable.'),
      h2('The honest answer'),
      p('Index funds build wealth more reliably, with less time, less stress, and better fit for the FIRE drawdown phase. Real estate can build wealth faster for skilled investors who use leverage effectively and manage properties well — but the "faster" claim often ignores the value of time, the risk of leverage, and the management overhead. For most people pursuing FIRE, a clear index fund strategy is the better path. Real estate is a meaningful supplement for those who actively enjoy property investing.'),
    ],
  },
  {
    slug: 'fire-at-different-income-levels',
    title: 'FIRE at Different Income Levels: $50k, $100k, and $200k',
    description: 'Financial independence is not just for high earners. Here is what the FIRE path looks like at three different income levels — and what actually determines the timeline.',
    category: 'FIRE Basics',
    publishedAt: '2026-06-17',
    readTime: '6 min read',
    body: [
      h2('The common misconception about FIRE and income'),
      p('The biggest myth about FIRE is that it requires a high income. Some of the most publicized FIRE stories — engineers retiring at 32 with $2 million portfolios — reinforce the idea that FIRE is only accessible to six-figure earners in tech. This is wrong.'),
      p('FIRE is determined by savings rate, not income level. A household earning $50,000 and saving 40% reaches FIRE in roughly the same number of years as a household earning $200,000 and saving 40%. The portfolios are very different sizes, but both represent the same principle: your money working for you rather than you working for money.'),
      h2('FIRE on $50,000 per year'),
      p('Household income: $50,000. Take-home after taxes (approximately): $42,000.'),
      h3('The lean FIRE path'),
      ul([
        'Annual spending: $25,000 (59% of take-home)',
        'Annual savings: $17,000 (41% savings rate)',
        'FIRE number: $625,000 ($25,000 × 25)',
        'Estimated years to FIRE at 7% return: ~18 years',
        'Starting from zero at age 25: FIRE at ~43',
      ]),
      h3('What makes this work'),
      ul([
        'Lean FIRE spending means housing in a lower-cost area (or with roommates), minimal car costs, and a cooking-at-home lifestyle',
        'Tax efficiency matters more at this income level: max Roth IRA contributions ($7,000 in 2024) on $17,000 of savings means nearly half goes into tax-advantaged accounts',
        'Geographic flexibility — ability to move to a lower-cost area — dramatically expands the option set',
        'Part-time work after achieving FI is common at this level: even $10,000/year in income cuts portfolio withdrawals in half',
      ]),
      h2('FIRE on $100,000 per year'),
      p('Household income: $100,000. Take-home after taxes (approximately): $78,000.'),
      h3('The standard FIRE path'),
      ul([
        'Annual spending: $50,000 (64% of take-home)',
        'Annual savings: $28,000 (36% savings rate)',
        'FIRE number: $1,250,000',
        'Estimated years to FIRE at 7% return: ~22 years',
        'Starting from zero at age 25: FIRE at ~47',
      ]),
      h3('Increasing savings rate to 50%'),
      ul([
        'Annual spending: $39,000',
        'Annual savings: $39,000',
        'FIRE number: $975,000',
        'Estimated years to FIRE: ~17 years',
        'Starting at 25: FIRE at ~42',
      ]),
      h3('What makes this work'),
      ul([
        'At $100k, tax-advantaged space becomes highly relevant: 401(k) ($23,000) + IRA ($7,000) = $30,000 sheltered',
        'This income level allows Housing + Transportation + Food optimization: these three categories often consume 60–70% of budgets; targeting them first moves the savings rate most',
        'Career trajectory matters: $100k at 30 is different from $100k as a ceiling — a rising income increases savings without changing lifestyle',
      ]),
      h2('FIRE on $200,000 per year'),
      p('Household income: $200,000. Take-home after taxes (approximately): $140,000 (varies significantly by state).'),
      h3('The fat FIRE or fast FIRE path'),
      ul([
        'Annual spending: $80,000 (57% of take-home)',
        'Annual savings: $60,000 (43% savings rate)',
        'FIRE number: $2,000,000',
        'Estimated years to FIRE at 7% return: ~20 years',
        'Starting from zero at 25: FIRE at ~45',
      ]),
      h3('Aggressive path (70% savings rate)'),
      ul([
        'Annual spending: $42,000',
        'Annual savings: $98,000',
        'FIRE number: $1,050,000',
        'Estimated years to FIRE: ~9 years',
        'Starting at 25: FIRE at ~34',
      ]),
      h3('What makes this work (and what does not)'),
      ul([
        'Lifestyle inflation is the primary risk at this income level: most households earning $200k spend $150k+, eliminating the savings rate advantage',
        'Tax complexity increases significantly: higher bracket, potential NIIT (3.8% on investment income), state taxes, AMT — tax planning has large dollar impact',
        'Backdoor Roth becomes relevant when income exceeds Roth IRA contribution limits (~$161k single, $240k married in 2024)',
        'The fast path is genuinely fast if lifestyle is kept in check — but "keeping lifestyle in check" at $200k requires active intention',
      ]),
      h2('What actually determines the timeline'),
      p('Across all income levels, the dominant variable is savings rate. The second is investment return consistency (index funds vs cash). The third is the spending assumption used for the FIRE number. Income level is a constraint on the maximum possible savings rate — but a 40% savings rate is achievable at $50k and a 40% savings rate is achievable at $200k. The mechanics are the same; the absolute numbers are different.'),
      p('The FIRE insight that equalises across income levels: every dollar saved and invested represents the same fraction of future freedom, regardless of where it came from.'),
      h2('The starting point matters less than people think'),
      p('These projections start from zero — no existing savings. If you start with $50,000 in a 401(k), the timeline shortens by 2–4 years. If you have student loans, it extends. If you receive an inheritance, it compresses dramatically. The FIRE timeline is sensitive to your starting position, but the underlying math — savings rate, return, target — does not change.'),
      p('The best time to start was five years ago. The next best time is today. Run the calculation with your actual numbers rather than waiting until you have higher income or lower debt. Even a modest savings rate started now compounds significantly over time.'),
    ],
  },
]
...
const articleMetaBySlug: Record<string, LearnArticleMeta> = {
  ...
  'healthcare-in-early-retirement-aca-cobra-coverage': {
    primaryStage: 'approaching-fire',
    secondaryStages: ['living-in-fire'],
    relatedCalculators: [
      { href: '/calculators/4-percent-rule', label: 'FIRE Number Calculator' },
    ...
    primaryCta: {
      ...
      label: 'Recalculate With Healthcare Costs',
      source: 'learn-healthcare-retirement',
    },
  },
  'real-estate-vs-index-funds-which-builds-wealth-faster': {
    primaryStage: 'building-momentum',
    secondaryStages: ['starting-out'],
    relatedCalculators: [
      { href: '/calculators/compound-interest', label: 'Compound Interest Calculator' },
    ...
    primaryCta: {
      ...
      label: 'Model Your Investment Returns',
      source: 'learn-real-estate-vs-index',
    },
  },
  'fire-at-different-income-levels': {
    ...
    secondaryStages: ['building-momentum'],
    relatedCalculators: [
      { href: '/?source=learn-income-levels', label: 'FIRE Calculator' },
      { href: '/calculators/savings-rate', label: 'Savings Rate Calculator' },
    ],
    primaryCta: {
      href: '/?source=learn-income-levels',
      label: 'Calculate Your FIRE Timeline',
      source: 'learn-fire-income-levels',
    },
  },
}
