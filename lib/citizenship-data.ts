...
export type CostOfLivingTier = "Low" | "Moderate" | "High" | "Very high";

// A national tier, not a city one — cost of living varies more by city than
// by country (a fact this app already treats seriously via per-city data in
// fire-data.ts), so read this as a rough starting point, not a substitute
// for picking an actual city.
export const CITIZENSHIP_COST_OF_LIVING: Record<string, CostOfLivingTier> = {
  us: "High",
  uk: "High",
  ca: "Moderate",
  au: "High",
