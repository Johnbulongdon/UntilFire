...
export const CITIES: City[] = [
  ...
  { name: 'Anaheim, CA',          key: 'anaheim',       col: 78000, state: 'ca',     flag: '🇺🇸' },
  { name: 'Irvine, CA',           key: 'irvine',        col: 88000, state: 'ca',     flag: '🇺🇸' },
  { name: 'Santa Ana, CA',        key: 'santaana',      col: 72000, state: 'ca',     flag: '🇺🇸' },
  { name: 'Riverside, CA',        key: 'riverside',     col: 62000, state: 'ca',     flag: '🇺🇸' },
  { name: 'Bakersfield, CA',      key: 'bakersfield',   col: 48000, state: 'ca',     flag: '🇺🇸' },
  { name: 'Stockton, CA',         key: 'stockton',      col: 54000, state: 'ca',     flag: '🇺🇸' },
  { name: 'Modesto, CA',          key: 'modesto',       col: 50000, state: 'ca',     flag: '🇺🇸' },
  { name: 'Santa Rosa, CA',       key: 'santarosa',     col: 70000, state: 'ca',     flag: '🇺🇸' },
  { name: 'Santa Barbara, CA',    key: 'santabarbara',  col: 82000, state: 'ca',     flag: '🇺🇸' },
  { name: 'Ventura, CA',          key: 'ventura',       col: 72000, state: 'ca',     flag: '🇺🇸' },
  { name: 'Monterey, CA',         key: 'monterey',      col: 72000, state: 'ca',     flag: '🇺🇸' },
  { name: 'Rochester, NY',        key: 'rochester_ny',  col: 46000, state: 'ny',     flag: '🇺🇸' },
  { name: 'Syracuse, NY',         key: 'syracuse',      col: 44000, state: 'ny',     flag: '🇺🇸' },
  { name: 'Yonkers, NY',          key: 'yonkers',       col: 68000, state: 'ny',     flag: '🇺🇸' },
  { name: 'White Plains, NY',     key: 'whiteplains',   col: 76000, state: 'ny',     flag: '🇺🇸' },
  { name: 'Huntington, NY',       key: 'huntington_ny', col: 70000, state: 'ny',     flag: '🇺🇸' },
  { name: 'Corpus Christi, TX',   key: 'corpuschristi', col: 42000, state: 'tx',     flag: '🇺🇸' },
  { name: 'Lubbock, TX',          key: 'lubbock',       col: 40000, state: 'tx',     flag: '🇺🇸' },
  { name: 'Arlington, TX',        key: 'arlington_tx',  col: 50000, state: 'tx',     flag: '🇺🇸' },
  { name: 'Irving, TX',           key: 'irving',        col: 52000, state: 'tx',     flag: '🇺🇸' },
  { name: 'Garland, TX',          key: 'garland',       col: 46000, state: 'tx',     flag: '🇺🇸' },
  { name: 'Frisco, TX',           key: 'frisco',        col: 58000, state: 'tx',     flag: '🇺🇸' },
  { name: 'McKinney, TX',         key: 'mckinney',      col: 54000, state: 'tx',     flag: '🇺🇸' },
  { name: 'Denton, TX',           key: 'denton',        col: 46000, state: 'tx',     flag: '🇺🇸' },
  { name: 'Waco, TX',             key: 'waco',          col: 40000, state: 'tx',     flag: '🇺🇸' },
  { name: 'Tallahassee, FL',      key: 'tallahassee',   col: 42000, state: 'fl',     flag: '🇺🇸' },
  { name: 'Naples, FL',           key: 'naples_fl',     col: 62000, state: 'fl',     flag: '🇺🇸' },
  { name: 'West Palm Beach, FL',  key: 'westpalmbeach', col: 58000, state: 'fl',     flag: '🇺🇸' },
  { name: 'Cape Coral, FL',       key: 'capecoral',     col: 46000, state: 'fl',     flag: '🇺🇸' },
  { name: 'Gainesville, FL',      key: 'gainesville_fl',col: 42000, state: 'fl',     flag: '🇺🇸' },
  { name: 'Fort Myers, FL',       key: 'fortmyers',     col: 50000, state: 'fl',     flag: '🇺🇸' },
  { name: 'Pensacola, FL',        key: 'pensacola',     col: 42000, state: 'fl',     flag: '🇺🇸' },
  { name: 'Bellevue, WA',         key: 'bellevue',      col: 90000, state: 'wa',     flag: '🇺🇸' },
  { name: 'Vancouver, WA',        key: 'vancouver_wa',  col: 54000, state: 'wa',     flag: '🇺🇸' },
  { name: 'Olympia, WA',          key: 'olympia',       col: 54000, state: 'wa',     flag: '🇺🇸' },
  { name: 'Salem, OR',            key: 'salem_or',      col: 48000, state: 'or',     flag: '🇺🇸' },
  { name: 'Bend, OR',             key: 'bend',          col: 56000, state: 'or',     flag: '🇺🇸' },
  { name: 'Aurora, CO',           key: 'aurora_co',     col: 56000, state: 'co',     flag: '🇺🇸' },
  { name: 'Fort Collins, CO',     key: 'fortcollins',   col: 54000, state: 'co',     flag: '🇺🇸' },
  { name: 'Lakewood, CO',         key: 'lakewood_co',   col: 58000, state: 'co',     flag: '🇺🇸' },
  { name: 'Ogden, UT',            key: 'ogden',         col: 44000, state: 'ut',     flag: '🇺🇸' },
  { name: 'St. George, UT',       key: 'stgeorge',      col: 50000, state: 'ut',     flag: '🇺🇸' },
  { name: 'Mesa, AZ',             key: 'mesa',          col: 48000, state: 'az',     flag: '🇺🇸' },
  { name: 'Tempe, AZ',            key: 'tempe',         col: 50000, state: 'az',     flag: '🇺🇸' },
  { name: 'Chandler, AZ',         key: 'chandler',      col: 52000, state: 'az',     flag: '🇺🇸' },
  { name: 'Gilbert, AZ',          key: 'gilbert',       col: 52000, state: 'az',     flag: '🇺🇸' },
  { name: 'Glendale, AZ',         key: 'glendale_az',   col: 46000, state: 'az',     flag: '🇺🇸' },
  { name: 'Henderson, NV',        key: 'henderson',     col: 52000, state: 'nv',     flag: '🇺🇸' },
  { name: 'Augusta, GA',          key: 'augusta_ga',    col: 40000, state: 'ga',     flag: '🇺🇸' },
  { name: 'Athens, GA',           key: 'athens_ga',     col: 42000, state: 'ga',     flag: '🇺🇸' },
  { name: 'Macon, GA',            key: 'macon',         col: 38000, state: 'ga',     flag: '🇺🇸' },
  { name: 'Alpharetta, GA',       key: 'alpharetta',    col: 58000, state: 'ga',     flag: '🇺🇸' },
  { name: 'Durham, NC',           key: 'durham',        col: 48000, state: 'nc',     flag: '🇺🇸' },
  { name: 'Greensboro, NC',       key: 'greensboro',    col: 42000, state: 'nc',     flag: '🇺🇸' },
  { name: 'Winston-Salem, NC',    key: 'winstonsalem',  col: 42000, state: 'nc',     flag: '🇺🇸' },
  { name: 'Wilmington, NC',       key: 'wilmington_nc', col: 48000, state: 'nc',     flag: '🇺🇸' },
  { name: 'Knoxville, TN',        key: 'knoxville',     col: 44000, state: 'tn',     flag: '🇺🇸' },
  { name: 'Franklin, TN',         key: 'franklin_tn',   col: 58000, state: 'tn',     flag: '🇺🇸' },
  { name: 'Louisville, KY',       key: 'louisville',    col: 44000, state: 'ky',     flag: '🇺🇸' },
  { name: 'Lexington, KY',        key: 'lexington_ky',  col: 42000, state: 'ky',     flag: '🇺🇸' },
  { name: 'Norfolk, VA',          key: 'norfolk',       col: 50000, state: 'va',     flag: '🇺🇸' },
  { name: 'Alexandria, VA',       key: 'alexandria_va', col: 70000, state: 'va',     flag: '🇺🇸' },
  { name: 'Arlington, VA',        key: 'arlington_va',  col: 78000, state: 'va',     flag: '🇺🇸' },
  { name: 'Charlottesville, VA',  key: 'charlottesville',col: 54000,state: 'va',     flag: '🇺🇸' },
  { name: 'Greenville, SC',       key: 'greenville_sc', col: 44000, state: 'sc',     flag: '🇺🇸' },
  { name: 'Myrtle Beach, SC',     key: 'myrtlebeach',   col: 46000, state: 'sc',     flag: '🇺🇸' },
  { name: 'Montgomery, AL',       key: 'montgomery',    col: 38000, state: 'al',     flag: '🇺🇸' },
  { name: 'Mobile, AL',           key: 'mobile',        col: 40000, state: 'al',     flag: '🇺🇸' },
  { name: 'Gulfport, MS',         key: 'gulfport',      col: 38000, state: 'ms',     flag: '🇺🇸' },
  { name: 'Fayetteville, AR',     key: 'fayetteville_ar',col:42000,state: 'ar_us',  flag: '🇺🇸' },
  { name: 'Ann Arbor, MI',        key: 'annarbor',      col: 52000, state: 'mi',     flag: '🇺🇸' },
  { name: 'Lansing, MI',          key: 'lansing',       col: 40000, state: 'mi',     flag: '🇺🇸' },
  { name: 'Toledo, OH',           key: 'toledo',        col: 38000, state: 'oh',     flag: '🇺🇸' },
  { name: 'Akron, OH',            key: 'akron',         col: 38000, state: 'oh',     flag: '🇺🇸' },
  { name: 'Dayton, OH',           key: 'dayton',        col: 38000, state: 'oh',     flag: '🇺🇸' },
  { name: 'Springfield, MO',      key: 'springfield_mo',col: 38000, state: 'mo',     flag: '🇺🇸' },
  { name: 'Columbia, MO',         key: 'columbia_mo',   col: 40000, state: 'mo',     flag: '🇺🇸' },
  { name: 'Green Bay, WI',        key: 'greenbay',      col: 42000, state: 'wi',     flag: '🇺🇸' },
  { name: 'Lincoln, NE',          key: 'lincoln',       col: 42000, state: 'ne',     flag: '🇺🇸' },
  { name: 'Iowa City, IA',        key: 'iowacity',      col: 42000, state: 'ia',     flag: '🇺🇸' },
  { name: 'Cedar Rapids, IA',     key: 'cedarrapids',   col: 40000, state: 'ia',     flag: '🇺🇸' },
  { name: 'Bismarck, ND',         key: 'bismarck',      col: 42000, state: 'nd',     flag: '🇺🇸' },
  { name: 'Edmond, OK',           key: 'edmond',        col: 40000, state: 'ok',     flag: '🇺🇸' },
  { name: 'Overland Park, KS',    key: 'overlandpark',  col: 48000, state: 'ks',     flag: '🇺🇸' },
  { name: 'Topeka, KS',           key: 'topeka',        col: 38000, state: 'ks',     flag: '🇺🇸' },
  { name: 'Worcester, MA',        key: 'worcester',     col: 58000, state: 'ma',     flag: '🇺🇸' },
  { name: 'Springfield, MA',      key: 'springfield_ma',col: 52000, state: 'ma',     flag: '🇺🇸' },
  { name: 'Stamford, CT',         key: 'stamford',      col: 76000, state: 'ct',     flag: '🇺🇸' },
  { name: 'Greenwich, CT',        key: 'greenwich',     col: 90000, state: 'ct',     flag: '🇺🇸' },
  { name: 'Allentown, PA',        key: 'allentown',     col: 48000, state: 'pa',     flag: '🇺🇸' },
  { name: 'Harrisburg, PA',       key: 'harrisburg',    col: 46000, state: 'pa',     flag: '🇺🇸' },
  { name: 'Manchester, NH',       key: 'manchester_nh', col: 54000, state: 'nh',     flag: '🇺🇸' },
  { name: 'Bangor, ME',           key: 'bangor',        col: 44000, state: 'me',     flag: '🇺🇸' },
  { name: 'Princeton, NJ',        key: 'princeton',     col: 76000, state: 'nj',     flag: '🇺🇸' },
  { name: 'Atlantic City, NJ',    key: 'atlanticcity',  col: 54000, state: 'nj',     flag: '🇺🇸' },
  { name: 'Trenton, NJ',          key: 'trenton',       col: 56000, state: 'nj',     flag: '🇺🇸' },
  { name: 'Newport, RI',          key: 'newport_ri',    col: 62000, state: 'ri',     flag: '🇺🇸' },
  { name: 'Wilmington, DE',       key: 'wilmington_de', col: 52000, state: 'de_us',     flag: '🇺🇸' },
  { name: 'Anchorage, AK',        key: 'anchorage',     col: 56000, state: 'ak',     flag: '🇺🇸' },
  { name: 'Fairbanks, AK',        key: 'fairbanks',     col: 52000, state: 'ak',     flag: '🇺🇸' },
  { name: 'Honolulu, HI',         key: 'honolulu',      col: 82000, state: 'hi',     flag: '🇺🇸' },
  { name: 'Kailua-Kona, HI',      key: 'kailuakona',    col: 72000, state: 'hi',     flag: '🇺🇸' },
  { name: 'Billings, MT',         key: 'billings',      col: 44000, state: 'mt',     flag: '🇺🇸' },
  { name: 'Missoula, MT',         key: 'missoula',      col: 46000, state: 'mt',     flag: '🇺🇸' },
  { name: 'Bozeman, MT',          key: 'bozeman',       col: 52000, state: 'mt',     flag: '🇺🇸' },
  { name: 'Cheyenne, WY',         key: 'cheyenne',      col: 42000, state: 'wy',     flag: '🇺🇸' },
  { name: 'Jackson, WY',          key: 'jackson_wy',    col: 82000, state: 'wy',     flag: '🇺🇸' },
  { name: 'Charleston, WV',       key: 'charleston_wv', col: 38000, state: 'wv',     flag: '🇺🇸' },
  { name: 'Morgantown, WV',       key: 'morgantown',    col: 40000, state: 'wv',     flag: '🇺🇸' },
  { name: 'Pasadena, CA',        key: 'pasadena_ca',   col: 76000, state: 'ca',     flag: '🇺🇸' },
  { name: 'Berkeley, CA',        key: 'berkeley',      col: 82000, state: 'ca',     flag: '🇺🇸' },
  { name: 'Glendale, CA',        key: 'glendale_ca',   col: 78000, state: 'ca',     flag: '🇺🇸' },
  { name: 'Palo Alto, CA',       key: 'paloalto',      col: 98000, state: 'ca',     flag: '🇺🇸' },
  { name: 'Laredo, TX',          key: 'laredo',        col: 38000, state: 'tx',     flag: '🇺🇸' },
  { name: 'Amarillo, TX',        key: 'amarillo',      col: 40000, state: 'tx',     flag: '🇺🇸' },
  { name: 'Brownsville, TX',     key: 'brownsville',   col: 36000, state: 'tx',     flag: '🇺🇸' },
  { name: 'Killeen, TX',         key: 'killeen',       col: 40000, state: 'tx',     flag: '🇺🇸' },
  { name: 'Midland, TX',         key: 'midland_tx',    col: 46000, state: 'tx',     flag: '🇺🇸' },
  { name: 'Boca Raton, FL',      key: 'bocaraton',     col: 62000, state: 'fl',     flag: '🇺🇸' },
  { name: 'Clearwater, FL',      key: 'clearwater',    col: 48000, state: 'fl',     flag: '🇺🇸' },
  { name: 'Lakeland, FL',        key: 'lakeland',      col: 42000, state: 'fl',     flag: '🇺🇸' },
  { name: 'Everett, WA',         key: 'everett',       col: 62000, state: 'wa',     flag: '🇺🇸' },
  { name: 'Bellingham, WA',      key: 'bellingham',    col: 56000, state: 'wa',     flag: '🇺🇸' },
  { name: 'Hillsboro, OR',       key: 'hillsboro',     col: 56000, state: 'or',     flag: '🇺🇸' },
  { name: 'Idaho Falls, ID',     key: 'idahofalls',    col: 42000, state: 'id',     flag: '🇺🇸' },
  { name: 'Flagstaff, AZ',       key: 'flagstaff',     col: 50000, state: 'az',     flag: '🇺🇸' },
  { name: 'North Las Vegas, NV', key: 'northlasvegas', col: 48000, state: 'nv',     flag: '🇺🇸' },
  { name: 'Columbus, GA',        key: 'columbus_ga',   col: 40000, state: 'ga',     flag: '🇺🇸' },
  { name: 'Norman, OK',          key: 'norman',        col: 40000, state: 'ok',     flag: '🇺🇸' },
  // ── CHINA
