  ...
  return (
    <header style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, cursor: "default" }}>
        <div style={{ width: 30, height: 30, borderRadius: 8, background: C.green800, display: "grid", placeItems: "center" }}>
          <svg width="16" height="16" viewBox="0 0 22 22" fill="none" aria-hidden>
            <line x1="2" y1="12" x2="20" y2="12" stroke="#62FAE3" strokeWidth="1.2" strokeLinecap="round" />
            <path d="M4 12 A7 7 0 0 1 18 12Z" fill="#62FAE3" />
            <line x1="4.07" y1="8.00" x2="2.34" y2="7.00" stroke="#62FAE3" strokeWidth="1.5" strokeLinecap="round" />
            <line x1="5.86" y1="5.87" x2="4.57" y2="4.34" stroke="#62FAE3" strokeWidth="1.5" strokeLinecap="round" />
            <line x1="8.26" y1="4.48" x2="7.59" y2="2.60" stroke="#62FAE3" strokeWidth="1.5" strokeLinecap="round" />
            <line x1="11" y1="4.00" x2="11" y2="2.00" stroke="#62FAE3" strokeWidth="1.5" strokeLinecap="round" />
            <line x1="13.74" y1="4.48" x2="14.41" y2="2.60" stroke="#62FAE3" strokeWidth="1.5" strokeLinecap="round" />
            <line x1="16.14" y1="5.87" x2="17.43" y2="4.34" stroke="#62FAE3" strokeWidth="1.5" strokeLinecap="round" />
            <line x1="17.93" y1="8.00" x2="19.66" y2="7.00" stroke="#62FAE3" strokeWidth="1.5" strokeLinecap="round" />
          </svg>
        </div>
        <span style={{ fontFamily: F, fontWeight: 800, fontSize: 18, color: C.green900, letterSpacing: "-0.3px" }}>
          UntilFire
        </span>
      </div>
  ...
  return (
    <section style={{ background: `linear-gradient(180deg, #fff 0%, ${C.mint} 100%)`, padding: "120px 40px 140px", overflow: "hidden" }}>
      <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
        <Reveal>
          <div style={{ width: 68, height: 68, borderRadius: 16, background: C.green800, display: "inline-grid", placeItems: "center", color: "#fff", boxShadow: "0 16px 40px rgba(0,53,39,0.25)", marginBottom: 24 }}>
            <svg width="32" height="32" viewBox="0 0 22 22" fill="none" aria-hidden>
              <line x1="2" y1="12" x2="20" y2="12" stroke="#62FAE3" strokeWidth="1.2" strokeLinecap="round" />
              <path d="M4 12 A7 7 0 0 1 18 12Z" fill="#62FAE3" />
              <line x1="4.07" y1="8.00" x2="2.34" y2="7.00" stroke="#62FAE3" strokeWidth="1.5" strokeLinecap="round" />
              <line x1="5.86" y1="5.87" x2="4.57" y2="4.34" stroke="#62FAE3" strokeWidth="1.5" strokeLinecap="round" />
