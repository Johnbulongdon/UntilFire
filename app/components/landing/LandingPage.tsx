      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, cursor: "default" }}>
        <div style={{ width: 30, height: 30, borderRadius: 8, background: C.green800, display: "grid", placeItems: "center" }}>
          <svg width="16" height="16" viewBox="0 0 22 22" fill="none" aria-hidden>
            <rect x="2" y="2" width="7" height="7" rx="1.5" fill="#62FAE3" />
            <rect x="13" y="2" width="7" height="7" rx="1.5" fill="rgba(255,255,255,0.45)" />
            <rect x="2" y="13" width="7" height="7" rx="1.5" fill="rgba(255,255,255,0.45)" />
            <rect x="13" y="13" width="7" height="7" rx="1.5" fill="#62FAE3" />
          </svg>
        </div>
        ...
        <Reveal>
          <div style={{ width: 68, height: 68, borderRadius: 16, background: C.green800, display: "inline-grid", placeItems: "center", color: "#fff", boxShadow: "0 16px 40px rgba(0,53,39,0.25)", marginBottom: 24 }}>
            <svg width="32" height="32" viewBox="0 0 22 22" fill="none" aria-hidden>
              <rect x="2" y="2" width="7" height="7" rx="1.5" fill={C.teal} />
              <rect x="13" y="2" width="7" height="7" rx="1.5" fill="rgba(255,255,255,0.4)" />
              <rect x="2" y="13" width="7" height="7" rx="1.5" fill="rgba(255,255,255,0.4)" />
              <rect x="13" y="13" width="7" height="7" rx="1.5" fill={C.teal} />
            </svg>
          </div>
        </Reveal>
        <Reveal delay={0.08}>
