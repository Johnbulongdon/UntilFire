      ...
      <section className="hero">
        <div className="hero-fold">
          ...
          <div className="hero-copy">
            ...
            <div className="hero-cta"><Button variant="primary" size="lg" onClick={onStart} style={{padding:"17px 30px",minHeight:56}}>Find my freedom date <span aria-hidden="true">↗</span></Button></div>
            {children}
          </div>
        </div>
