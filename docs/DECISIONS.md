...
screens say "adjusted for inflation to <month>". The figure itself waits on
the BLS API, which refused anonymous requests that day (daily quota reached). (b) The survey measures a
